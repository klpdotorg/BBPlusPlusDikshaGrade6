...
Game.ALP_01_G6level1.prototype =
{
    ...
    gameCreate: function (game) {
        ...
        _this.backbtn.events.onInputDown.add(function () {
            //_this.state.start('ALP_01_G6Score');
    ...
    createAudio: function (src) {
        ...
        audiosrc.setAttribute("src", "questionSounds/ALP-01-G6/" + _this.languageSelected + "/" + src + ".mp3");
    ...
    DemoVideo:function()
    {
        ...
        _this.demoAudio1src.setAttribute("src", "questionSounds/ALP-01-G6/" + _this.languageSelected + "/DV1-ALP-01-G6.mp3");
        _this.demoAudio1.appendChild(_this.demoAudio1src);

        //*  here rule is '3 n' , so total number of match sticks are 3 multiply by 8 which is equal to 24
        _this.demoAudio2 = document.createElement('audio');
        _this.demoAudio2src = document.createElement('source');
        _this.demoAudio2src.setAttribute("src", "questionSounds/ALP-01-G6/" + _this.languageSelected + "/DV3-ALP-01-G6.mp3");
        _this.demoAudio2.appendChild(_this.demoAudio2src);

        //*  Find a rule to give the number of match sticks required to make  the given pattern.
        _this.q1Sound = document.createElement('audio');
        _this.q1Soundsrc = document.createElement('source');
        _this.q1Soundsrc.setAttribute("src", "questionSounds/ALP-01-G6/" + 
        ...
        _this.q2Soundsrc.setAttribute("src", "questionSounds/ALP-01-G6/" + 
        ...
        _this.q3Soundsrc.setAttribute("src", "questionSounds/ALP-01-G6/" + 
       ...
       // *  Enter the number of patterns
        ...
        _this.q4Soundsrc.setAttribute("src", "questionSounds/ALP-01-G6/" + 
    ...
    showDemoVideo:function()
    {
        ...
        _this.demoVideo_1.changeSource("demoVideos/ALP-01-G6_1.mp4");
        ...
        _this.demoVideo_1.onComplete.add(function()
        {
            ...
            _this.demoVideo_2.changeSource("demoVideos/ALP-01-G6_2.mp4");  //* phaser needs this.to run in mobile
            ...
            _this.demoVideo_2.onComplete.add(function()
            {
                ...
                _this.demoVideo_3.changeSource("demoVideos/ALP-01-G6_3.mp4");  //* phaser needs this.to run in mobile
