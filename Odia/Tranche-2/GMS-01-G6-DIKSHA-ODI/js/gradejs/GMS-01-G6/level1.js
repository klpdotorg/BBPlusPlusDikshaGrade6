...
Game.GMS_01_G6level1.prototype = {
    ...
    init: function (param, score) {
        ...
        _this.correctanssrc.setAttribute("src", "sounds/celebration.mp3");
        ...
        _this.selecttilesrc.setAttribute("src", "sounds/ClickSound.mp3");
        ...
        _this.drawingsoundsrc.setAttribute("src", "sounds/drawing sound.mp3");
    ...
    createAudio: function (src) {
        ...
        audiosrc.setAttribute("src", "questionSounds/GMS-01-G6/" + _this.languageSelected + "/" + src + ".mp3");
    ...
    getVoice: function () {
        ...
        if (_this.languageSelected == "English") {
            _this.src.setAttribute("src", "questionSounds/GMS-01-G6/English/GMS_01_G6.mp3");
        }
        else if (_this.languageSelected == "Hindi") {
            _this.src.setAttribute("src", "questionSounds/GMS-01-G6/Hindi/GMS_01_G6.mp3");
        }
        else if (_this.languageSelected == "Kannada") {
            _this.src.setAttribute("src", "questionSounds/GMS-01-G6/Kannada/GMS_01_G6.mp3");
        }
        else if (_this.languageSelected == "Gujarati") {
            _this.src.setAttribute("src", "questionSounds/GMS-01-G6/Gujarati/GMS_01_G6.mp3");
        }
        else if (_this.languageSelected == "Marathi") {
            _this.src.setAttribute("src", "questionSounds/GMS-01-G6/Marathi/GMS_01_G6.mp3");
        }
        else if (_this.languageSelected == "Telugu") {
            _this.src.setAttribute("src", "questionSounds/GMS-01-G6/Telugu/GMS_01_G6.mp3");
        }
        else if (_this.languageSelected == "Tamil") {
            _this.src.setAttribute("src", "questionSounds/GMS-01-G6/Tamil/GMS_01_G6.mp3");
        }
        else if (_this.languageSelected == "Urdu") {
            _this.src.setAttribute("src", "questionSounds/GMS-01-G6/Urdu/GMS_01_G6.mp3");
        }
        else {
    ...
    DemoVideo:function()
    {
        ...
        _this.q1Soundsrc.setAttribute("src", "questionSounds/GMS-01-G6/" + 
    ...
    showDemoVideo:function()
    {
        ...
        _this.demoVideo_1.changeSource("demoVideos/GMS-01-G6.mp4");
