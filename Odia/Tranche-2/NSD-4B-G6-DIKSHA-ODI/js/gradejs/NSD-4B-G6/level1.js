...
Game.NSD_4B_G6level1.prototype =
{
    ...
    gameCreate: function (game) {
        ...
        _this.backbtn.events.onInputDown.add(function () {
           // _this.state.start('NSD_4B_G6Score');
    ...
    createAudio: function (src) {
        ...
        audiosrc.setAttribute("src", "questionSounds/NSD-4B-G6/" + _this.languageSelected + "/" + src + ".mp3");
    ...
    rightbtnClicked: function () {
        ...
        if (_this.AnswerBox.name === _this.AnswerValues[_this.count1]) {
            _this.correctAns();
    ...
    DemoVideo:function()
    {
        ...
        _this.demoAudio1src.setAttribute("src", "questionSounds/NSD-4B-G6/" + 
                                            _this.languageSelected + "/DV-NSD-4B-G6.mp3");
        _this.demoAudio1.appendChild(_this.demoAudio1src);

        _this.q1Sound = document.createElement('audio');
        _this.q1Soundsrc = document.createElement('source');
        _this.q1Soundsrc.setAttribute("src", "questionSounds/NSD-4B-G6/" + 
    ...
    showDemoVideo:function()
    {
        ...
        _this.demoVideo_1.changeSource("demoVideos/NSD-4B-G6.mp4");
