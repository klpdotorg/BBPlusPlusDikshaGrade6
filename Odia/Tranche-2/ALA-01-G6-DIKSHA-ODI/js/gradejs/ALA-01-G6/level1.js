...
//* Change this function to show small number pad as given in GDD. (no signs)
    ...
    CallingNextQuestion:function()
    {
        ...
        else
        {
            _this.timer1.stop();
            _this.timer1=null;
            _this.time.events.add(2000,function(){ _this.state.start('score')});
        }
...
//* this is called when a number on num pad is clicked.
    ...
    VoiceNote1Fn:function()
    {
        ...
        _this.VoiceNote1src.setAttribute("src", "questionSounds/ALA-01-G6/"+_this.languageSelected+"/ALA-01-A.mp3");
    ...
    VoiceNote2Fn:function()
    {
        ...
        _this.VoiceNote2src.setAttribute("src", "questionSounds/ALA-01-G6/"+_this.languageSelected+"/ALA-01-B.mp3");
    ...
    VoiceNote3Fn:function()
    {
        ...
        _this.VoiceNote3src.setAttribute("src", "questionSounds/ALA-01-G6/"+_this.languageSelected+"/ALA-01-C.mp3");
    ...
    VoiceNote4Fn:function()
    {
        ...
        _this.VoiceNote4src.setAttribute("src", "questionSounds/ALA-01-G6/"+_this.languageSelected+"/ALA-01-D.mp3");
    ...
    DemoVideo:function()
    {
        ...
        _this.demoAudio1src.setAttribute("src", "questionSounds/ALA-01-G6/" + _this.languageSelected + "/DV-ALA-01-G6.mp3");
        _this.demoAudio1.appendChild(_this.demoAudio1src);

        //* Drag the strips and square pieces onto the grid to represent the given decimal number.
        _this.q1Sound = document.createElement('audio');
        _this.q1Soundsrc = document.createElement('source');
        _this.q1Soundsrc.setAttribute("src", "questionSounds/ALA-01-G6/" + 
        ...
        _this.q2Soundsrc.setAttribute("src", "questionSounds/ALA-01-G6/" + 
        ...
        _this.q3Soundsrc.setAttribute("src", "questionSounds/ALA-01-G6/" + 
    ...
    showDemoVideo:function()
    {
        ...
        _this.demoVideo_1.changeSource("demoVideos/ALA-01-G6.mp4");
