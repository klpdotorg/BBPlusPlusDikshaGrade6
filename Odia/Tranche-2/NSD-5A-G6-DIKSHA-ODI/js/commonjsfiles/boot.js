...
Game.boot.prototype = {
	...
	create: function () {
		...
		//		else if(param1 == 12)   hornbill game int-5
		//		{
		//			console.log(param1);
		//			//this.state.start('preloader_int_7');
		//		}
		//		else if(param1 == 13)  hornbill game int-6
		//		{
		//			console.log(param1);
		//			//this.state.start('preloader_int_8');
		//		}
		//		else if(param1 == 14)  hornbill game int-7
		//		{
		//			console.log(param1);
		...
		//		else if(param1 == 21)   //* hornbill game int-14
		//		{
		//			console.log(param1);
		...
		//		}
			...
			console.log("inside boot.js with param1 = " + param1);
			this.state.start('preloader_nsd_01');
		}
		else if (param1 == 35) {
			console.log(param1);
