...
Game.Score.prototype={
	...
	create:function(game){
		...
		// 	},_this);
		_this.replay = _this.add.button(_this.world.centerX+170,_this.world.centerY,'CommonReplayBtn',null,_this,0,1,2);
		...
		_this.nextBtn = _this.add.sprite(_this.world.centerX,_this.world.centerY,'CommonNextBtn');    
