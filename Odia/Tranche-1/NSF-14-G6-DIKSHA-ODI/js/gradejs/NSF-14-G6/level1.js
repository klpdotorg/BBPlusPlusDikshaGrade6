...
Game.NSF_14_G6level1.prototype =
{
    init: function (game) {
        ...
        _this.ColorChangeSoundsrc.setAttribute("src", "sounds/Game_Asset_Disappear.mp3");
    ...
    askQn1: function () {
        ...
        _this.Question1src.setAttribute("src",  "questionSounds/NSF-14-G6/" +  _this.languageSelected + "/NSF-14-G6-a.mp3");
    ...
    askQn2: function () {
        ...
        _this.Question2src.setAttribute("src", "questionSounds/NSF-14-G6/" +  _this.languageSelected + "/NSF-14-G6-d.mp3");
    ...
    askQn3: function () {
        ...
        _this.Question3src.setAttribute("src", "questionSounds/NSF-14-G6/" +  _this.languageSelected + "/NSF-14-G6-e.mp3");
    ...
    askQn4: function () {
        ...
        _this.Question4src.setAttribute("src", "questionSounds/NSF-14-G6/" + _this.languageSelected + "/NSF-14-G6-b.mp3");
    ...
    askQn41: function () {
        ...
        _this.Question41src.setAttribute("src", "questionSounds/NSF-14-G6/" + _this.languageSelected + "/NSF-14-G6-c.mp3");
    ...
    DemoVideo: function()
    {
        ...
        _this.demoAudio1src.setAttribute("src", "questionSounds/NSF-14-G6/" + 
        ...
        _this.q1Soundsrc.setAttribute("src", "questionSounds/NSF-14-G6/" + 
      ...
      //  //* Find the difference between the given fractions. 
        ...
        _this.q2Soundsrc.setAttribute("src", "questionSounds/NSF-14-G6/" + 
      ...
      //  //*Drag the remaining fraction pieces to the whole.
        ...
        _this.q3Soundsrc.setAttribute("src", "questionSounds/NSF-14-G6/" + 
        ...
        _this.q4Soundsrc.setAttribute("src", "questionSounds/NSF-14-G6/" + 
        ...
        _this.q5Soundsrc.setAttribute("src", "questionSounds/NSF-14-G6/" + 
   ...
   // * function & actual videos/audios to understand the flow of audio and video.
    ...
    showDemoVideo: function()
    {
        ...
        _this.demoVideo_1.changeSource("demoVideos/NSF-14-G6_1.mp4");
