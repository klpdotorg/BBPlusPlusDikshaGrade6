...
Game.NS_INT_7_G6demo.prototype = {
    ...
    init: function (GameNumber) {
        ...
        _this.demoAudio1src.setAttribute("src", "questionSounds/NS-INT-10-G6/" +
        ...
        _this.demoAudio2src.setAttribute("src", "questionSounds/NS-INT-10-G6/" +
        ...
        _this.demoAudio3src.setAttribute("src", "questionSounds/NS-INT-10-G6/" +
        ...
        _this.demoAudio4src.setAttribute("src", "questionSounds/NS-INT-10-G6/" +
        ...
        _this.demoAudio5src.setAttribute("src", "questionSounds/NS-INT-10-G6/" +
        ...
        _this.demoAudio6src.setAttribute("src", "questionSounds/NS-INT-10-G6/" +
        ...
        _this.demoAudio7src.setAttribute("src", "questionSounds/NS-INT-10-G6/" +
        ...
        _this.demoAudio8src.setAttribute("src", "questionSounds/NS-INT-10-G6/" +
        ...
        _this.demoAudio9src.setAttribute("src", "questionSounds/NS-INT-10-G6/" +
        ...
        _this.q1Soundsrc.setAttribute("src", "questionSounds/NS-INT-10-G6/" +
    ...
    dA3: function () {
        ...
        _this.demoVideo_2.changeSource('demoVideos/NS-INT-7-G6_2.mp4');  //* phaser needs this.to run in mobile
    ...
    dA5: function () {
        ...
        _this.demoVideo_3.changeSource('demoVideos/NS-INT-7-G6_3.mp4');  //* phaser needs this.to run in mobile
        _this.video_playing = 2;
    ...
    showDemoVideo: function () {
        ...
        _this.demoVideo_1.changeSource('demoVideos/NS-INT-7-G6_1.mp4');
        ...
        _this.demoVideo_3.onComplete.add(function () {
            ...
            _this.demoVideo_4.changeSource('demoVideos/NS-INT-7-G6_4.mp4');  //* phaser needs this.to run in mobile
            _this.video_playing = 2;
            _this.demoVideo_4.addToWorld();
            _this.backbtn.bringToTop();               //* bring backbtn and skip to top.
            _this.skip.bringToTop();
            _this.time.events.add(2500, function () {
                _this.demoAudio8.play();
                console.log("demoAudio8")
            })
        });
