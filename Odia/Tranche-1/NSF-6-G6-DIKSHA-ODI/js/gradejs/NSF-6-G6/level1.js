...
Game.NSF_6_G6level1.prototype={
  ...
  if(!window.grade5NSF2){
        ...
        this.load.image('F2_5backg', 'assets/gradeAssets/NSF-6-G6/backg.png');
        
        this.load.image('F2_5plate',  'assets/gradeAssets/NSF-6-G6/plate.png');
        this.load.image('F2_5greenplate',  'assets/gradeAssets/NSF-6-G6/greenplate.png');
        this.load.image('F2_5orangeplate',  'assets/gradeAssets/NSF-6-G6/orangeplate.png');
        this.load.image('F2_5A3',  'assets/gradeAssets/NSF-6-G6/A3.png');
        this.load.image('F2_5A4',  'assets/gradeAssets/NSF-6-G6/A4.png');
        this.load.image('F2_5A5',  'assets/gradeAssets/NSF-6-G6/A5.png');
        this.load.image('F2_5A6',  'assets/gradeAssets/NSF-6-G6/A6.png');
        this.load.image('F2_5A7',  'assets/gradeAssets/NSF-6-G6/A7.png');
        this.load.image('F2_5A8',  'assets/gradeAssets/NSF-6-G6/A8.png');
        this.load.image('F2_5A9',  'assets/gradeAssets/NSF-6-G6/A9.png');
        this.load.image('F2_5A10',  'assets/gradeAssets/NSF-6-G6/A10.png');
        this.load.image('F2_5B3',  'assets/gradeAssets/NSF-6-G6/B3.png');
        this.load.image('F2_5B4',  'assets/gradeAssets/NSF-6-G6/B4.png');
        this.load.image('F2_5B5',  'assets/gradeAssets/NSF-6-G6/B5.png');
        this.load.image('F2_5B6',  'assets/gradeAssets/NSF-6-G6/B6.png');
        this.load.image('F2_5B7',  'assets/gradeAssets/NSF-6-G6/B7.png');
        this.load.image('F2_5B8',  'assets/gradeAssets/NSF-6-G6/B8.png');
        this.load.image('F2_5B9',  'assets/gradeAssets/NSF-6-G6/B9.png');
        this.load.image('F2_5B10',  'assets/gradeAssets/NSF-6-G6/B10.png');
        this.load.image('F2_5C3',  'assets/gradeAssets/NSF-6-G6/C3.png');
        this.load.image('F2_5C4',  'assets/gradeAssets/NSF-6-G6/C4.png');
        this.load.image('F2_5C5',  'assets/gradeAssets/NSF-6-G6/C5.png');
        this.load.image('F2_5C6',  'assets/gradeAssets/NSF-6-G6/C6.png');
        this.load.image('F2_5C7',  'assets/gradeAssets/NSF-6-G6/C7.png');
        this.load.image('F2_5C8',  'assets/gradeAssets/NSF-6-G6/C8.png');
        this.load.image('F2_5C9',  'assets/gradeAssets/NSF-6-G6/C9.png');
        this.load.image('F2_5C10',  'assets/gradeAssets/NSF-6-G6/C10.png');
        this.load.image('F2_5bottombar',  'assets/gradeAssets/NSF-6-G6/bottombar.png');
        this.load.image('F2_5line',  'assets/gradeAssets/NSF-6-G6/line.png');
        this.load.atlas('F2_5box1', 'assets/gradeAssets/NSF-6-G6/box1.png', 'assets/gradeAssets/NSF-6-G6/box1.json');
        this.load.atlas('F2_5cloud1', 'assets/gradeAssets/NSF-6-G6/cloud1.png', 'assets/gradeAssets/NSF-6-G6/cloud1.json');
        this.load.atlas('F2_5cloud2', 'assets/gradeAssets/NSF-6-G6/cloud2.png', 'assets/gradeAssets/NSF-6-G6/cloud2.json');
        this.load.atlas('F2_5erase', 'assets/gradeAssets/NSF-6-G6/erase.png', 'assets/gradeAssets/NSF-6-G6/erase.json');
        this.load.atlas('F2_5rightmark', 'assets/gradeAssets/NSF-6-G6/rightmark.png', 'assets/gradeAssets/NSF-6-G6/rightmark.json');
        this.load.atlas('F2_5numberpad', 'assets/gradeAssets/NSF-6-G6/numberpad.png', 'assets/gradeAssets/NSF-6-G6/numberpad.json');
        this.load.atlas('F2_5numbers', 'assets/gradeAssets/NSF-6-G6/numbers.png', 'assets/gradeAssets/NSF-6-G6/numbers.json');
        this.load.atlas('F2_5numbers1', 'assets/gradeAssets/NSF-6-G6/numbers1.png', 'assets/gradeAssets/NSF-6-G6/numbers1.json');
        this.load.atlas('F2_5numbers2', 'assets/gradeAssets/NSF-6-G6/numbers2.png', 'assets/gradeAssets/NSF-6-G6/numbers2.json');
        this.load.atlas('F2_5compare', 'assets/gradeAssets/NSF-6-G6/compare.png', 'assets/gradeAssets/NSF-6-G6/compare.json');
    }
 ...
 getVoice:function(){
        ...
        switch(_this.qArrays[_this.no11])
        {
            ...
            case 10:if(_this.languageSelected =="ENG")
                    {
                         _this.src.setAttribute("src",  "questionSounds/NSF-6-G6/ENG/NSF-6-G6.mp3");
                    }
                    else if(_this.languageSelected =="HIN")
                    {
                        _this.src.setAttribute("src",  "questionSounds/NSF-6-G6/HIN/NSF-6-G6.mp3");
                    }
                    else if(_this.languageSelected =="KAN")
                    {
                         _this.src.setAttribute("src",  "questionSounds/NSF-6-G6/KAN/NSF-6-G6.mp3");
                    }
                    else if(_this.languageSelected =="GUJ")
                    {
                         _this.src.setAttribute("src",  "questionSounds/NSF-6-G6/GUJ/NSF-6-G6.mp3");
                    }
					else if(_this.languageSelected =="MAR")
                    {
                         _this.src.setAttribute("src",  "questionSounds/NSF-6-G6/MAR/NSF-6-G6.mp3");
                    }
					else if(_this.languageSelected =="TEL")
                    {
                         _this.src.setAttribute("src",  "questionSounds/NSF-6-G6/TEL/NSF-6-G6.mp3");
                    }
					else if(_this.languageSelected =="TAM")
                    {
                         _this.src.setAttribute("src",  "questionSounds/NSF-6-G6/TAM/NSF-6-G6.mp3");
                    }
					else if(_this.languageSelected =="URD")
                    {
                         _this.src.setAttribute("src",  "questionSounds/NSF-6-G6/URD/NSF-6-G6.mp3");
                    }
                  else if(_this.languageSelected =="ODI")
                    {
                        _this.src.setAttribute("src",  "questionSounds/NSF-6-G6/ODI/NSF-6-G6.mp3");
