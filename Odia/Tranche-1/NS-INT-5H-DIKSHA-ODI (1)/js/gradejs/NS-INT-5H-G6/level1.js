...
Game.NS_INT_5H_G6level1.prototype =
{
    init: function (game) {
        ...
        _this.dicerollsrc.setAttribute("src", "sounds/diceroll.mp3");
        ...
        _this.correctanssrc.setAttribute("src", "sounds/correctans.mp3");
        ...
        _this.selecttilesrc.setAttribute("src", "sounds/selecttile.mp3");
        ...
        _this.jumpsrc.setAttribute("src", "sounds/jump.mp3");
    ...
    handanimation: function () {
        console.log("handanimation Q111")
        _this.askQn1();
        _this.qn_flag = 1;
        _this.time.events.add(400, () => {
    ...
    showDicehand: function () {
        ...
        _this.hand.scale.setTo(0.7)
        console.log("showDicehand Q222")
       // _this.time.events.add(4000,_this.askQn2)
        _this.askQn2();
        _this.time.events.add(700, () => {
            _this.hand.scale.setTo(0.65);
    ...
    showTickhand: function () {
        ...
        _this.hand.scale.setTo(0.7)
        console.log("askQn4")
       // _this.time.events.add(2000,_this.askQn4);
        _this.askQn4();
        _this.time.events.add(700, () => {
            _this.hand.scale.setTo(0.65);
...
// Resets frog positio n if selected tile is wrong
    ...
    askdemo1: function () {
        ...
        _this.demoVo1src.setAttribute("src", "questionSounds/NS-INT-5H-G6/"+_this.languageSelected +"/NS-INT-5-G6 demo 1.mp3");
    ...
    askdemo2: function () {
        ...
        _this.demoVo2src.setAttribute("src", "questionSounds/NS-INT-5H-G6/"+_this.languageSelected +"/NS-INT-5-G6 demo 2.mp3");
    ...
    askdemo3: function () {
        ...
        _this.demoVo3src.setAttribute("src", "questionSounds/NS-INT-5H-G6/"+_this.languageSelected +"/NS-INT-5-G6 demo 3.mp3");
    ...
    askQn1: function () {
        ...
        _this.Question1src.setAttribute("src", "questionSounds/NS-INT-5H-G6/"+_this.languageSelected +"/ClickFrogVO.mp3");
    ...
    askQn2: function () {
        ...
        _this.Question2src.setAttribute("src", "questionSounds/NS-INT-5H-G6/"+_this.languageSelected +"/RollDiceVO.mp3");
    ...
    askQn3: function () {
        ...
        _this.Question2 = document.createElement('audio');
        _this.Question2src = document.createElement('source');
        _this.Question2src.setAttribute("src", "questionSounds/NS-INT-5H-G6/"+_this.languageSelected +"/SelectTileVO.mp3");
        _this.Question2.appendChild(_this.Question2src);
        _this.Question2.play();
    },
    askQn4: function () {
        ...
        _this.Question2 = document.createElement('audio');
        _this.Question2src = document.createElement('source');
        _this.Question2src.setAttribute("src", "questionSounds/NS-INT-5H-G6/"+_this.languageSelected +"/ClickCheckVO.mp3");
        _this.Question2.appendChild(_this.Question2src);
        _this.Question2.play();
    },
    eraseAll: function () {
