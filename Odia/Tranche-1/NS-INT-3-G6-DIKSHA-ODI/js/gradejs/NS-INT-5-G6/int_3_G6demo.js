...
Game.NS_INT_3_G6demo.prototype = {
    ...
    init: function (game) {
        ...
        _this.q1Soundsrc.setAttribute("src", "questionSounds/NS-INT-5-G6/" +
        ...
        _this.q2Soundsrc.setAttribute("src", "questionSounds/NS-INT-5-G6/" +
    ...
    showDemoVideo: function () {
        ...
        _this.demoVideo_1.changeSource("demoVideos/NS-INT-3-G6_1.mp4");
        ...
        _this.demoVideo_1.onComplete.add(function ()    //* on completion of video1, play 2nd video.
        {
            ...
            _this.demoVideo_2.changeSource("demoVideos/NS-INT-3-G6_2.mp4");
