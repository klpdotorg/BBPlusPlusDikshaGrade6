...
Game.NS_INT_6H_G6level1.prototype =
{
    ...
    showBoxSelection: function () {
        ...
        _this.time.events.add(3600, () => {
            console.log("Q444")
            _this.askQn4();
            _this.time.events.add(1800, _this.showDrag)
            // _this.showDrag();
        })
    ...
    selectQues: function () {
        ...
        if (_this.selectedQues == 0) {
            // smaller integer
            _this.time.events.add(1100, _this.askQn2);
           // _this.askQn2();
            _this.qn_flag = 2;
        }
        else {
            _this.time.events.add(1100, _this.askQn3);
          //  _this.askQn3();
            _this.qn_flag = 3;
        }
    },
    ...
    askdemo1: function () {
        ...
        _this.demoVo1src.setAttribute("src", "questionSounds/NS-INT-6H-G6/"+_this.languageSelected +"/NS-INT-6-G6 demo 1.mp3");
    ...
    askQn1: function () {
        ...
        _this.Question1src.setAttribute("src", "questionSounds/NS-INT-6H-G6/"+_this.languageSelected +"/ClickFrogVO.mp3");
    ...
    askQn2: function () {
        ...
        _this.Question2src.setAttribute("src", "questionSounds/NS-INT-6H-G6/"+_this.languageSelected +"/NS-INT-6-G6 a.mp3");
    ...
    askQn3: function () {
        ...
        _this.Question2 = document.createElement('audio');
        _this.Question2src = document.createElement('source');
        _this.Question2src.setAttribute("src", "questionSounds/NS-INT-6H-G6/"+_this.languageSelected +"/NS-INT-6-G6 c.mp3");
        _this.Question2.appendChild(_this.Question2src);
        _this.Question2.play();
    },
    askQn4: function () {
        ...
        _this.Question2 = document.createElement('audio');
        _this.Question2src = document.createElement('source');
        _this.Question2src.setAttribute("src", "questionSounds/NS-INT-6H-G6/"+_this.languageSelected +"/NS-INT-6-G6 b.mp3");
        _this.Question2.appendChild(_this.Question2src);
        _this.Question2.play();
    },
    askQn5: function () {
        ...
        _this.Question2 = document.createElement('audio');
        _this.Question2src = document.createElement('source');
        _this.Question2src.setAttribute("src", "questionSounds/NS-INT-6H-G6/"+_this.languageSelected +"/ClickCheckVO.mp3");
        _this.Question2.appendChild(_this.Question2src);
        _this.Question2.play();
    },
    eraseAll: function () {
