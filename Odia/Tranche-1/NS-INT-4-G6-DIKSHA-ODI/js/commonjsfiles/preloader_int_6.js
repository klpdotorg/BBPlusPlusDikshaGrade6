...
Game.preloader_int_6.prototype={
	preload:function(){
        ...
        this.load.image('plus', 'assets/gradeAssets/NS-INT-6-G6/plus symbol.png');
        this.load.image('minus', 'assets/gradeAssets/NS-INT-6-G6/minus symbol.png');
...
//        this.load.atlas('plusMinusZero','assets/gradeAssets/NS-INT-6-G6/Symbol +-O.png',null,game6Json.plusMinusZeroJson);
        ...
        this.load.atlas('plusApple','assets/gradeAssets/NS-INT-6-G6/apple_anm_plus.png', null,game6Json.plusAppleJson);
        this.load.atlas('minusApple','assets/gradeAssets/NS-INT-6-G6/apple_anm_minus.png', null,game6Json.minusAppleJson);
        this.load.atlas('Bellanim','assets/gradeAssets/NS-INT-6-G6/Bell anim.png',null,game6Json.BellanimJson);
        this.load.atlas('minusGlow','assets/gradeAssets/NS-INT-6-G6/minus symbol_glow.png', null, game6Json.minusglowJson);
        this.load.atlas('plusGlow','assets/gradeAssets/NS-INT-6-G6/plus symbol_glow.png', null,game6Json.plusglowJson);
	},
