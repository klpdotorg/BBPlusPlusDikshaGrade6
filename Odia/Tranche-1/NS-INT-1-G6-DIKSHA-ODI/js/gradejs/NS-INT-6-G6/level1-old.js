...
Game.NS_INT_6_G6level1.prototype ={
    ...
    init:function(game)
    {
       ...
       //telInitializer.gameIdInit("sequence2_1_1a",gradeSelected);
        ...
        _this.bellsoundsrc.setAttribute("src", "sounds/bellsound.mp3");
...
//        console.log("8 "+_this.NoOfApple[7]);
    ...
    gotoSixthQuestion:function(){
        ...
        //_this.spot1X=313;//red plus apple
        //_this.spot1Y=225;//red plus apple

        _this.plusAppleX=554;//light plus apple
        _this.plusAppleY=98;//light plus apple

        //_this.plusApple1X=552;
        //_this.plusApple1Y=95;


        /*_this.NoOfApple = [1,2,3,4,5,6,7,8];
        _this.NoOfApple = _this.shuffle(_this.NoOfApple);*/
//        console.log("apple"+_this.NoOfApple[_this.flag2]);

        _this.signplus=1;
        _this.signminus=1;
        
//        console.log("options"+_this.Q6_options[_this.flag1]);
        ...
        _this.bgarray[0];
//        console.log(_this.bgarray[0]+" 0 for boy,1 for girl ");
        ...
        _this.Q6_3options();
//        console.log(_this.NoOfApple[_this.flag2]+" no of apple");
    },
    

    Q6_3options:function(target){
        
    console.log(_this.Q6_options[1]);
    console.log(_this.Q6_options[_this.flag1]);
...
//            console.log("plz select num of tranaction");
            ...
            _this.time.events.add(6000, _this.Q6_AppleInTray);
...
Q6_SellerVoice:function(){
        ...
        switch(_this.Q6_options[_this.flag1])
        {
            case 1: if (_this.NoOfApple[_this.flag2] > 1)
                    {
                        _this.src.setAttribute("src", "questionSounds/NS-INT-6-G6/English/please_take_the_fruits.mp3");
                    }
                    else if (_this.NoOfApple[_this.flag2] == 1)
                    {
                        _this.src.setAttribute("src", "questionSounds/NS-INT-6-G6/English/please_take_this_fruit.mp3");
                    }                
                
                    break;
            case 2:_this.src.setAttribute("src", "questionSounds/NS-INT-6-G6/English/i_dont_have_any_fruits.mp3");
                    break;
            case 3:_this.src.setAttribute("src", "questionSounds/NS-INT-6-G6/English/i dont have any today i will give you tommarow.mp3");
                    break;
...
Q6_Question:function(){
        ...
        switch(1)
        {
            case 1: _this.src.setAttribute("src", "questionSounds/NS-INT-6-G6/English/please_select_num_of_transaction.mp3");
                    break;
...
Q6_options_2:function(){
        ...
        _this.BoyGirlAsking_2();
        //i_dont_have_any_fruits

        console.log("i dont have any fruits");
        
        _this.time.events.add(2000, _this.Q6_SellerVoice);
        _this.time.events.add(6000, _this.Q6_Question);
    
        _this.manAnim =_this.man.animations.add('Store_man', [3,4,5,6,7,8,9,10,11,3,4,5,6,7,8,9,10,11], true);    
        _this.time.events.add(1800,function() { _this.man.animations.play('Store_man', 28, false, false)});
...
Q6_options_3:function(target){
        ...
        _this.time.events.add(2000, _this.Apple_no);
...
//                        _this.bitesound.play();});
                    ...
                    else
                    {
                        ...
                        _this.timer1.stop();
                        _this.timer1=null;
                        _this.time.events.add(3000,function(){ _this.state.start('NS_INT_G6Menu')});
