...
//*************************************************************************************************
        ...
        _this.demoAudio1src.setAttribute("src", "questionSounds/NS-LCM-1-G6/" + 
        ...
        _this.q1Soundsrc.setAttribute("src", "questionSounds/NS-LCM-1-G6/" + 
        ...
        _this.q2Soundsrc.setAttribute("src", "questionSounds/NS-LCM-1-G6/" + 
    ...
    dA1: function()
    {
        ...
        _this.demoVideo_2.changeSource('demoVideos/NS-LCM-1-G6_2.mp4');  //* phaser needs this.to run in mobile
        ...
        _this.time.events.add(16000, function()           //* pause video after 1.5sec for Question to complete
        {
            _this.q2Sound.play();
        });
    },
    ...
    showDemoVideo: function()
    {
        ...
        _this.demoVideo_1.changeSource('demoVideos/NS-LCM-1-G6_1.mp4');
