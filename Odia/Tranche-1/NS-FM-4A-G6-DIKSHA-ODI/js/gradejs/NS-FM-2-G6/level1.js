...
Game.NS_FM_2_G6level1.prototype =
{
    init:function (minutes, seconds, counterForTimer)
    {
        ...
        _this.counterColorchangesrc.setAttribute("src", "sounds/colour_change.mp3");
        ...
        _this.deletefactorSoundsrc.setAttribute("src", "sounds/Game_Asset_Disappear-new.mp3");
        ...
        _this.TraySoundsrc.setAttribute("src", "sounds/Egg_Counter_onTray.mp3");
        ...
        _this.crackSoundsrc.setAttribute("src", "sounds/egg_cracking.wav");
        ...
        _this.boxHighlightsrc.setAttribute("src", "sounds/Next_option_sound.mp3");
...
//    },
    ...
    Choosefactors:function(OddEvenAudio)
    {
        ...
        _this.Question = document.createElement('audio');
        _this.Questionsrc = document.createElement('source');
        _this.Questionsrc.setAttribute("src", "questionSounds/NS-FM-2-G6/" + 
