...
BoyGirlAsking:function(){
    ...
    _this.src.setAttribute("src", "questionSounds/NS-INT-6-G6/" + _this.languageSelected + 
                           "/NS-INT-4-G6-a.mp3");
...
Apple_no:function(){
    ...
    switch(_this.NoOfApple[_this.flag2])
    {
        case 1: _this.src.setAttribute("src", "questionSounds/NS-INT-6-G6/" + _this.languageSelected + 
                                       "/one-frt.mp3");
                break;
        case 2: _this.src.setAttribute("src", "questionSounds/NS-INT-6-G6/" + _this.languageSelected + 
                                       "/two-frt.mp3");
                break;
        case 3: _this.src.setAttribute("src", "questionSounds/NS-INT-6-G6/" + _this.languageSelected + 
                                       "/three-frt.mp3");
                break;  
        case 4: _this.src.setAttribute("src", "questionSounds/NS-INT-6-G6/" + _this.languageSelected + 
                                       "/four-frt.mp3");
                break;
        case 5: _this.src.setAttribute("src", "questionSounds/NS-INT-6-G6/" + _this.languageSelected + 
                                       "/five-frt.mp3");
                break;
        case 6: _this.src.setAttribute("src", "questionSounds/NS-INT-6-G6/" + _this.languageSelected + 
                                       "/six-frt.mp3");
                break;
        case 7: _this.src.setAttribute("src", "questionSounds/NS-INT-6-G6/" + _this.languageSelected + 
                                       "/seven-frt.mp3");
                break;
        case 8: _this.src.setAttribute("src", "questionSounds/NS-INT-6-G6/" + _this.languageSelected + 
                                       "/eight-frt.mp3");
                break;
