...
//            console.log("hihi");
    ...
    voiceNote1:function()
    {
            ...
            _this.Question1src.setAttribute("src", "questionSounds/NSF-5-G6/" + 
                                       _this.languageSelected + "/let_us_find_equivalent_fraction_of.mp3");
    ...
    voiceNote2:function()
    {
            ...
            _this.Question2src.setAttribute("src", "questionSounds/NSF-5-G6/" + 
                                       _this.languageSelected + "/are_these_equi_fracton.mp3");
    ...
    voiceNote3:function()
    {
            ...
            _this.Question3src.setAttribute("src", "questionSounds/NSF-5-G6/" + 
                                       _this.languageSelected + "/Enter_the_equivalent_fractions.mp3");
