...
Game.NS_PRM_1_G6level1.prototype =
{
    init:function(game)
    {
        ...
        _this.AppleSlicesrc.setAttribute("src", "sounds/CarrotBite.mp3");
...
//        _this.element = 25;
    ...
    Ask_LetUsFind:function()
    {
        ...
        _this.Letusfindsrc.setAttribute("src", "questionSounds/NS-PRM-1-G6/" + 
    ...
    Ask_SelectOption:function()
    {
        ...
        _this.SelectOptionsrc.setAttribute("src", "questionSounds/NS-PRM-1-G6/" + 
    ...
    Ask_HowManyLines:function(OddEvenAudio)
    {
        ...
        _this.Questionsrc.setAttribute("src", "questionSounds/NS-PRM-1-G6/" + 
