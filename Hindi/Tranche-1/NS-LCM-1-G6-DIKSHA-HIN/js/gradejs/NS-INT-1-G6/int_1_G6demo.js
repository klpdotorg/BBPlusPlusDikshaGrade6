...
//*************************************************************************************************
        ...
        _this.q1Soundsrc.setAttribute("src", "questionSounds/NS-INT-1-G6/" + 
                                         _this.languageSelected + "/mns-3.mp3");
        _this.q1Sound.appendChild(_this.q1Soundsrc);
        
        _this.q2Sound = document.createElement('audio');
        _this.q2Soundsrc = document.createElement('source');
        _this.q2Soundsrc.setAttribute("src", "questionSounds/NS-INT-2-G6/" + 
    ...
    showDemoVideo: function()
    {
        ...
        _this.demoVideo_1.changeSource("demoVideos/NS-INT-1-G6_1.mp4");
        _this.demoVideo_1.addToWorld();
        ...
        _this.demoVideo_1.onComplete.add(function()    //* on completion of video1, play 2nd video.
        {
            ...
            _this.demoVideo_2.changeSource("demoVideos/NS-INT-1-G6_2.mp4");
        ...
        _this.demoVideo_2.onComplete.add(function()   //* on completion of video2, play 3rd video.
        {
            ...
            _this.demoVideo_3.changeSource("demoVideos/NS-INT-1-G6_3.mp4");
