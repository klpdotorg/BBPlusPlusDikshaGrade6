...
Game.NS_OE_1A_G6level1.prototype =
{
    ...
    init: function (game) {
        ...
        _this.arrangeinpairssrc.setAttribute("src", "questionSounds/NS-OE-1A-G6/" + _this.languageSelected 
                                             + "/OE-drag.mp3");
        ...
        _this.oddquestionSoundsrc.setAttribute("src", "questionSounds/NS-OE-1A-G6/" + _this.languageSelected 
                                             + "/NS-OE-1A-G6-a.mp3");
        ...
        _this.evenquestionSoundsrc.setAttribute("src", "questionSounds/NS-OE-1A-G6/" + _this.languageSelected 
                                             + "/NS-OE-1A-G6-b.mp3");
        ...
        _this.hatchSoundsrc.setAttribute("src", "sounds/egg_cracking.wav");
        ...
        _this.tweenSoundsrc.setAttribute("src", "sounds/Egg_Counter_onTray.mp3");
