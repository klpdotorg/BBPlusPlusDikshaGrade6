...
Game.ALS_01_MCQ_G6level1.prototype =
{
    init: function (param, score) {
        ...
        _this.puffSoundsrc.setAttribute("src", "sounds/Bubble Burst.mp3");
        ...
        _this.dropSoundsrc.setAttribute("src", "sounds/goingdown.mp3");
    ...
    gameCreate: function (game) {
        ...
        _this.backbtn.events.onInputDown.add(function () {
            //_this.state.start('ALS_01_G6Score');
    ...
    createAudio: function (src) {
        ...
        audiosrc.setAttribute("src", "questionSounds/ALS-01-MCQ-G6/" + _this.languageSelected + "/" + src + ".mp3");
    ...
    //     _this.Question1src.setAttribute("src", "questionSounds/ALS-01-G6/English/V1.mp3");
    ...
    //     _this.Question2src.setAttribute("src", "questionSounds/ALS-01-G6/English/V2.mp3");
    ...
    //     _this.Question3src.setAttribute("src", "questionSounds/ALS-01-G6/English/V3.mp3");
    ...
    part2Ques: function () {
        _this.QnBox = _this.add.image(100, 50, 'textbox');

        _this.QnBox.scale.setTo(0.8, 0.8);
    ...
    DemoVideo:function()
    {
        ...
        _this.demoAudio1src.setAttribute("src", "questionSounds/ALS-01-MCQ-G6/" + _this.languageSelected + "/DV-ALS-01-MCQ-G6.mp3");
        _this.demoAudio1.appendChild(_this.demoAudio1src);

        //* The number of remaining objects are equal to the value of the variable
        _this.demoAudio2 = document.createElement('audio');
        _this.demoAudio2src = document.createElement('source');
        _this.demoAudio2src.setAttribute("src", "questionSounds/ALS-01-MCQ-G6/" + _this.languageSelected + "/DV1-ALS-01-MCQ-G6.mp3");
        _this.demoAudio2.appendChild(_this.demoAudio2src);

        //* Use One on one mapping to find the value of a variable
        _this.q1Sound = document.createElement('audio');
        _this.q1Soundsrc = document.createElement('source');
        _this.q1Soundsrc.setAttribute("src", "questionSounds/ALS-01-MCQ-G6/" + 
        ...
        _this.q2Soundsrc.setAttribute("src", "questionSounds/ALS-01-MCQ-G6/" + 
        ...
        _this.q3Soundsrc.setAttribute("src", "questionSounds/ALS-01-MCQ-G6/" + 
        ...
        // _this.q4Soundsrc.setAttribute("src", "questionSounds/ALS-01-MCQ-G6/" + 
    ...
    showDemoVideo:function()
    {
        ...
        _this.demoVideo_1.changeSource("demoVideos/ALS-01-G6_1.mp4");
        ...
        _this.demoVideo_1.onComplete.add(function()
        {
            ...
            _this.demoVideo_2.changeSource("demoVideos/ALS-01-G6_2.mp4");  //* phaser needs this.to run in mobile
