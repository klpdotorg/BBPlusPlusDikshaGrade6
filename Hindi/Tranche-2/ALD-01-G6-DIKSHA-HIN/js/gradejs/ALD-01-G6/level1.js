...
Game.ALD_01_G6level1.prototype =
{
    ...
    init:function(game)
    {
        ...
        _this.PuffSoundsrc.setAttribute("src", "sounds/PuffSound.mp3");
        ...
        _this.bubbleSoundsrc.setAttribute("src", "sounds/WaterBubbling.mp3");
        ...
        _this.WaterDropSoundsrc.setAttribute("src", "sounds/watersplash.mp3");
    ...
    gameCreate:function(game)
    {
        ...
        {
            //_this.state.start('NS_FM_1_G6Score');
    ...
    displayInitialScreen : function()
    {
        ...
        _this.initBox = _this.add.image( 140,400,"Text box_1");
        _this.initBoxText = _this.add.text( 170,420,"a");
        _this.initBoxText.fill = '#FF0000';
        //_this.displayBigtankFish();
        //* display Equation 
        //* y =x/z
       _this.equationBox = _this.add.image(100,50,'Text box_4');
       _this.equationBox.scale.setTo(0.8,0.8);
      
       _this.addY = _this.add.text(135,63,_this.QYArray[_this.count1]);
       _this.applyingStyle(_this.addY);
       _this.addEqlsign = _this.add.text(160,63,"=");
       _this.applyingStyle(_this.addEqlsign);
       _this.addX = _this.add.text(190,63,"a");
       _this.addX.fill = '#FF0000';
       _this.addDivsign = _this.add.text(210,63,"/");
       _this.applyingStyle(_this.addDivsign);
       _this.addZ = _this.add.text(230,63,_this.QZArray[_this.count1]);
    ...
    fillBowl1: function() 
    {
        ...
        //* add necessary sounds and bubble animation
...
//* this is called when a number on num pad is clicked.
    ...
    VoiceNote1Fn:function()
    {
        ...
        _this.VoiceNote1src.setAttribute("src", "questionSounds/ALD-01-G6/"+_this.languageSelected+"/ALD-01-G6A.mp3");
    ...
    VoiceNote2Fn:function()
    {
        ...
        _this.VoiceNote2src.setAttribute("src", "questionSounds/ALD-01-G6/"+_this.languageSelected+"/ALD-01-G6B.mp3");
    ...
    VoiceNote3Fn:function()
    {
        ...
        _this.VoiceNote3src.setAttribute("src", "questionSounds/ALD-01-G6/"+_this.languageSelected+"/ALD-01-G6C.mp3");
    ...
    VoiceNote4Fn:function()
    {
        ...
        _this.VoiceNote3 = document.createElement('audio');
        _this.VoiceNote3src = document.createElement('source');
        _this.VoiceNote3src.setAttribute("src", "questionSounds/ALD-01-G6/"+_this.languageSelected+"/ALD-01-G6D.mp3");
        _this.VoiceNote3.appendChild(_this.VoiceNote3src);
        _this.VoiceNote3.play();
    ...
    DemoVideo:function()
    {
        ...
        _this.demoAudio1src.setAttribute("src", "questionSounds/ALD-01-G6/" + _this.languageSelected + "/DV-ALD-01-G6.mp3");
        _this.demoAudio1.appendChild(_this.demoAudio1src);

        //*  How many objects are needed in big tank to balance the equation?
        _this.q1Sound = document.createElement('audio');
        _this.q1Soundsrc = document.createElement('source');
        _this.q1Soundsrc.setAttribute("src", "questionSounds/ALD-01-G6/" + 
        ...
        _this.q2Soundsrc.setAttribute("src", "questionSounds/ALD-01-G6/" + 
        ...
        _this.q3Soundsrc.setAttribute("src", "questionSounds/ALD-01-G6/" + 
       ...
       // *  Complete the equation 
        ...
        _this.q4Soundsrc.setAttribute("src", "questionSounds/ALD-01-G6/" + 
    ...
    showDemoVideo:function()
    {
        ...
        _this.demoVideo_1.changeSource("demoVideos/ALD-01-G6_1.mp4");
        ...
        _this.demoVideo_1.onComplete.add(function()
        {
            ...
            _this.demoVideo_2.changeSource("demoVideos/ALD-01-G6_2.mp4");  //* phaser needs this.to run in mobile
            ...
            _this.demoVideo_2.onComplete.add(function()
            {
                ...
                _this.demoVideo_3.changeSource("demoVideos/ALD-01-G6_3.mp4");  //* phaser needs this.to run in mobile
