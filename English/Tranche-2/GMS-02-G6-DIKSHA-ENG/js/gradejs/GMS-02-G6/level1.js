...
Game.GMS_02_G6level1.prototype = {
    ...
    createAudio: function (src) {
        ...
        audiosrc.setAttribute("src", "questionSounds/GMS-02-G6/" + _this.languageSelected + "/" + src + ".mp3");
    ...
    DemoVideo:function()
    {
        ...
        _this.q1Soundsrc.setAttribute("src", "questionSounds/GMS-02-G6/" + 
                                        _this.languageSelected + "/GMS-02-G6A.mp3");
        _this.q1Sound.appendChild(_this.q1Soundsrc);

        _this.q2Sound = document.createElement('audio');
        _this.q2Soundsrc = document.createElement('source');
        _this.q2Soundsrc.setAttribute("src", "questionSounds/GMS-02-G6/" + 
    ...
    showDemoVideo:function()
    {
        ...
        _this.demoVideo_1.changeSource("demoVideos/GMS-02-G6.mp4");
