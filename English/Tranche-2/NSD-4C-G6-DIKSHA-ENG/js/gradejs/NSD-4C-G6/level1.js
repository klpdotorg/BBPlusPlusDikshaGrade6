...
Game.NSD_4C_G6level1.prototype =
{
    ...
    gameCreate: function (game) {
        ...
        _this.backbtn.events.onInputDown.add(function () {
          // _this.state.start('NSD_4C_G6Score');
    ...
    createAudio: function (src) {
        ...
        audiosrc.setAttribute("src", "questionSounds/NSD-4C-G6/" + _this.languageSelected + "/" + src + ".mp3");
    ...
    Validation: function () {
        ...
        if (_this.decBox1 == true && Value100Array[_this.count1] == 0 && _this.AnswerBox.name === boxname2) {
            _this.decBox1 = false;
            _this.decBox2 = true;
        ...
        else if (_this.decBox2 == true && Value100Array2[_this.count1] == 0 && _this.AnswerBox.name === boxname2) {
            _this.decBox2 = false;
            _this.part2 = true
        ...
        else if (_this.AnswerBox.name === boxname) {
    ...
    DemoVideo:function()
    {
        ...
        _this.demoAudio1src.setAttribute("src", "questionSounds/NSD-4C-G6/" + 
                                            _this.languageSelected + "/DV-NSD-4C-G6.mp3");
        _this.demoAudio1.appendChild(_this.demoAudio1src);

        _this.q1Sound = document.createElement('audio');
        _this.q1Soundsrc = document.createElement('source');
        _this.q1Soundsrc.setAttribute("src", "questionSounds/NSD-4C-G6/" + 
                                        _this.languageSelected + "/NSD-4C-G6A.mp3");
        _this.q1Sound.appendChild(_this.q1Soundsrc);

        _this.q2Sound = document.createElement('audio');
        _this.q2Soundsrc = document.createElement('source');
        _this.q2Soundsrc.setAttribute("src", "questionSounds/NSD-4C-G6/" + 
                                        _this.languageSelected + "/NSD-4C-G6B.mp3");
        _this.q2Sound.appendChild(_this.q2Soundsrc);

        _this.q3Sound = document.createElement('audio');
        _this.q3Soundsrc = document.createElement('source');
        _this.q3Soundsrc.setAttribute("src", "questionSounds/NSD-4C-G6/" + 
    ...
    showDemoVideo:function()
    {
        ...
        _this.demoVideo_1.changeSource("demoVideos/NSD-4C-G6.mp4");
