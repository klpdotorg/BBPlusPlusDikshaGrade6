    ...
    getVoice: function () {
        ...
        switch (_this.qArrays[_this.no1]) {
            case 1:
                ...
                if (window.languageSelected == "ENG") {
                    _this.src.setAttribute("src", "questionSounds/GMCR-01-G6/ENG/sg16.1.4a.mp3");
                }
                else if (window.languageSelected == "HIN") {
                    _this.src.setAttribute("src", "questionSounds/GMCR-01-G6/HIN/sg16.1.4a.mp3");

                }
                else if (window.languageSelected == "KAN") {
                    _this.src.setAttribute("src", "questionSounds/GMCR-01-G6/KAN/sg16.1.4a.mp3");

                }
                else if (window.languageSelected == "Gujarati") {
                    _this.src.setAttribute("src", "questionSounds/GMCR-01-G6/Gujrati/sg16.1.4a.mp3");

                }
                else if (window.languageSelected == "Marathi") {
                    _this.src.setAttribute("src", "questionSounds/GMCR-01-G6/Marathi/sg16.1.4a.mp3");

                }
                else if (window.languageSelected == "Telugu") {
                    _this.src.setAttribute("src", "questionSounds/GMCR-01-G6/Telugu/sg16.1.4a.mp3");

                }
                else if (window.languageSelected == "Tamil") {
                    _this.src.setAttribute("src", "questionSounds/GMCR-01-G6/Tamil/sg16.1.4a.mp3");

                }
                else if (window.languageSelected == "Urdu") {
                    _this.src.setAttribute("src", "questionSounds/GMCR-01-G6/Urdu/sg16.1.4a.mp3");
                }
                else {
                    _this.src.setAttribute("src", "questionSounds/GMCR-01-G6/Odiya/sg16.1.4a.mp3");
                }
                break;
            case 2:
                if (window.languageSelected == "ENG") {
                    _this.src.setAttribute("src", "questionSounds/GMCR-01-G6/ENG/sg16.1.4b.mp3");
                }
                else if (window.languageSelected == "HIN") {
                    _this.src.setAttribute("src", "questionSounds/GMCR-01-G6/HIN/sg16.1.4b.mp3");
                }
                else if (window.languageSelected == "KAN") {
                    _this.src.setAttribute("src", "questionSounds/GMCR-01-G6/KAN/sg16.1.4b.mp3");
                }
                else if (window.languageSelected == "Gujarati") {
                    _this.src.setAttribute("src", "questionSounds/GMCR-01-G6/Gujrati/sg16.1.4b.mp3");
                }
                else if (window.languageSelected == "Marathi") {
                    _this.src.setAttribute("src", "questionSounds/GMCR-01-G6/Marathi/sg16.1.4b.mp3");
                }
                else if (window.languageSelected == "Telugu") {
                    _this.src.setAttribute("src", "questionSounds/GMCR-01-G6/Telugu/sg16.1.4b.mp3");
                }
                else if (window.languageSelected == "Tamil") {
                    _this.src.setAttribute("src", "questionSounds/GMCR-01-G6/Tamil/sg16.1.4b.mp3");
                }
                else if (window.languageSelected == "Urdu") {
                    _this.src.setAttribute("src", "questionSounds/GMCR-01-G6/Urdu/sg16.1.4b.mp3");
                }
                else {
                    _this.src.setAttribute("src", "questionSounds/GMCR-01-G6/Odiya/sg16.1.4b.mp3");

                }
                break;
            case 3:
                if (window.languageSelected == "ENG") {
                    _this.src.setAttribute("src", "questionSounds/GMCR-01-G6/ENG/sg16.1.4c.mp3");
                }
                else if (window.languageSelected == "HIN") {
                    _this.src.setAttribute("src", "questionSounds/GMCR-01-G6/HIN/sg16.1.4c.mp3");
                }
                else if (window.languageSelected == "KAN") {
                    _this.src.setAttribute("src", "questionSounds/GMCR-01-G6/KAN/sg16.1.4c.mp3");
                }
                else if (window.languageSelected == "Gujarati") {
                    _this.src.setAttribute("src", "questionSounds/GMCR-01-G6/Gujrati/sg16.1.4c.mp3");
                }
                else if (window.languageSelected == "Marathi") {
                    _this.src.setAttribute("src", "questionSounds/GMCR-01-G6/Marathi/sg16.1.4c.mp3");
                }
                else if (window.languageSelected == "Telugu") {
                    _this.src.setAttribute("src", "questionSounds/GMCR-01-G6/Telugu/sg16.1.4c.mp3");
                }
                else if (window.languageSelected == "Tamil") {
                    _this.src.setAttribute("src", "questionSounds/GMCR-01-G6/Tamil/sg16.1.4c.mp3");
                }
                else if (window.languageSelected == "Urdu") {
                    _this.src.setAttribute("src", "questionSounds/GMCR-01-G6/Urdu/sg16.1.4c.mp3");
                }
                else {
                    _this.src.setAttribute("src", "questionSounds/GMCR-01-G6/Odiya/sg16.1.4c.mp3");
            ...
            case 4:
                console.log("case 4")
                if (window.languageSelected == "ENG") {
                    _this.src.setAttribute("src", "questionSounds/GMCR-01-G6/ENG/sg16.1.4d.mp3");
                }
                else if (window.languageSelected == "HIN") {
                    _this.src.setAttribute("src", "questionSounds/GMCR-01-G6/HIN/sg16.1.4d.mp3");
                }
                else if (window.languageSelected == "KAN") {
                    _this.src.setAttribute("src", "questionSounds/GMCR-01-G6/KAN/sg16.1.4d.mp3");
                }
                else if (window.languageSelected == "Gujarati") {
                    _this.src.setAttribute("src", "questionSounds/GMCR-01-G6/Gujrati/sg16.1.4d.mp3");
                }
                else if (window.languageSelected == "Marathi") {
                    _this.src.setAttribute("src", "questionSounds/GMCR-01-G6/Marathi/sg16.1.4d.mp3");
                }
                else if (window.languageSelected == "Telugu") {
                    _this.src.setAttribute("src", "questionSounds/GMCR-01-G6/Telugu/sg16.1.4d.mp3");
                }
                else if (window.languageSelected == "Tamil") {
                    _this.src.setAttribute("src", "questionSounds/GMCR-01-G6/Tamil/sg16.1.4d.mp3");
                }
                else if (window.languageSelected == "Urdu") {
                    _this.src.setAttribute("src", "questionSounds/GMCR-01-G6/Urdu/sg16.1.4d.mp3");
                }
                else {
                    _this.src.setAttribute("src", "questionSounds/GMCR-01-G6/Odiya/sg16.1.4d.mp3");

                }
                break;
            case 5:
                if (window.languageSelected == "ENG") {
                    _this.src.setAttribute("src", "questionSounds/GMCR-01-G6/ENG/sg16.1.4e.mp3");
                }
                else if (window.languageSelected == "HIN") {
                    _this.src.setAttribute("src", "questionSounds/GMCR-01-G6/HIN/sg16.1.4e.mp3");
                }
                else if (window.languageSelected == "KAN") {
                    _this.src.setAttribute("src", "questionSounds/GMCR-01-G6/KAN/sg16.1.4e.mp3");
                }
                else if (window.languageSelected == "Gujarati") {
                    _this.src.setAttribute("src", "questionSounds/GMCR-01-G6/Gujrati/sg16.1.4e.mp3");
                }
                else if (window.languageSelected == "Marathi") {
                    _this.src.setAttribute("src", "questionSounds/GMCR-01-G6/Marathi/sg16.1.4e.mp3");
                }
                else if (window.languageSelected == "Telugu") {
                    _this.src.setAttribute("src", "questionSounds/GMCR-01-G6/Telugu/sg16.1.4e.mp3");
                }
                else if (window.languageSelected == "Tamil") {
                    _this.src.setAttribute("src", "questionSounds/GMCR-01-G6/Tamil/sg16.1.4e.mp3");
                }
                else if (window.languageSelected == "Urdu") {
                    _this.src.setAttribute("src", "questionSounds/GMCR-01-G6/Urdu/sg16.1.4e.mp3");
                }
                else {
                    _this.src.setAttribute("src", "questionSounds/GMCR-01-G6/Odiya/sg16.1.4e.mp3");
                }
                break;
            case 6:
                if (window.languageSelected == "ENG") {
                    _this.src.setAttribute("src", "questionSounds/GMCR-01-G6/ENG/sg16.1.4f.mp3");
                }
                else if (window.languageSelected == "HIN") {
                    _this.src.setAttribute("src", "questionSounds/GMCR-01-G6/HIN/sg16.1.4f.mp3");
                }
                else if (window.languageSelected == "KAN") {
                    _this.src.setAttribute("src", "questionSounds/GMCR-01-G6/KAN/sg16.1.4f.mp3");
                }
                else if (window.languageSelected == "Gujarati") {
                    _this.src.setAttribute("src", "questionSounds/GMCR-01-G6/Gujrati/sg16.1.4f.mp3");
                }
                else if (window.languageSelected == "Marathi") {
                    _this.src.setAttribute("src", "questionSounds/GMCR-01-G6/Marathi/sg16.1.4f.mp3");
                }
                else if (window.languageSelected == "Telugu") {
                    _this.src.setAttribute("src", "questionSounds/GMCR-01-G6/Telugu/sg16.1.4f.mp3");
                }
                else if (window.languageSelected == "Tamil") {
                    _this.src.setAttribute("src", "questionSounds/GMCR-01-G6/Tamil/sg16.1.4f.mp3");
                }
                else if (window.languageSelected == "Urdu") {
                    _this.src.setAttribute("src", "questionSounds/GMCR-01-G6/Urdu/sg16.1.4f.mp3");
                }
                else {
                    _this.src.setAttribute("src", "questionSounds/GMCR-01-G6/Odiya/sg16.1.4f.mp3");
                }
                break;
        }
