...
Game.NSD_2B_G6level1.prototype =
{
    ...
    gameCreate: function (game) {
        ...
        _this.backbtn.events.onInputDown.add(function () {
            //_this.state.start('NSD_2B_G6Score');
    ...
    createAudio: function (src) {
        ...
        audiosrc.setAttribute("src", "questionSounds/NSD-2B-G6/" + _this.languageSelected + "/" + src + ".mp3");
    ...
    DemoVideo:function()
    {
        ...
        _this.demoAudio1src.setAttribute("src", "questionSounds/NSD-2B-G6/" + _this.languageSelected + "/DV-NSD_2B_G6A.mp3");
        _this.demoAudio1.appendChild(_this.demoAudio1src);

         //*  Decimal fractions are fractions with denominators 10, 100, 1000 and so on.
         _this.demoAudio2 = document.createElement('audio');
         _this.demoAudio2src = document.createElement('source');
         _this.demoAudio2src.setAttribute("src", "questionSounds/NSD-2B-G6/" + _this.languageSelected + "/DV-NSD_2B_G6B.mp3");
         _this.demoAudio2.appendChild(_this.demoAudio2src);

        //* Drag the unifix cubes and find the equivalent decimal fraction
        _this.q1Sound = document.createElement('audio');
        _this.q1Soundsrc = document.createElement('source');
        _this.q1Soundsrc.setAttribute("src", "questionSounds/NSD-2B-G6/" + 
        ...
        _this.q2Soundsrc.setAttribute("src", "questionSounds/NSD-2B-G6/" + 
        ...
        _this.q3Soundsrc.setAttribute("src", "questionSounds/NSD-2B-G6/" + 
    ...
    showDemoVideo:function()
    {
        ...
        _this.demoVideo_1.changeSource("demoVideos/NSD-2B-G6.mp4");
