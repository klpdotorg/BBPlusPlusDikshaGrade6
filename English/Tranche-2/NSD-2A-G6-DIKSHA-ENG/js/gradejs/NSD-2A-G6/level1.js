...
Game.NSD_2A_G6level1.prototype =
{
    ...
    gameCreate: function (game) {
        ...
        _this.backbtn.events.onInputDown.add(function () {
            //_this.state.start('NSD_2A_G6Score');
    ...
    createAudio: function (src) {
        ...
        audiosrc.setAttribute("src", "questionSounds/NSD-2A-G6/" + _this.languageSelected + "/" + src + ".mp3");
    ...
    DemoVideo:function()
    {
        ...
        _this.demoAudio1src.setAttribute("src", "questionSounds/NSD-2A-G6/" + _this.languageSelected + "/DV-NSD-2A-G6.mp3");
        _this.demoAudio1.appendChild(_this.demoAudio1src);

        //* Drag the strips and square pieces onto the grid to represent the given decimal number.
        _this.q1Sound = document.createElement('audio');
        _this.q1Soundsrc = document.createElement('source');
        _this.q1Soundsrc.setAttribute("src", "questionSounds/NSD-2A-G6/" + 
        ...
        _this.q2Soundsrc.setAttribute("src", "questionSounds/NSD-2A-G6/" + 
        ...
        _this.q3Soundsrc.setAttribute("src", "questionSounds/NSD-2A-G6/" + 
    ...
    showDemoVideo:function()
    {
        ...
        _this.demoVideo_1.changeSource("demoVideos/NSD-2A-G6.mp4");
