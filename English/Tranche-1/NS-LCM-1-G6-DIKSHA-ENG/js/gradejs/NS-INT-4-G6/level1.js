...
//    },
    ...
    getVoice2:function()
    {
        ...
        {
            case 0: _this.src.setAttribute("src", "questionSounds/NS-INT-4-G6/" + _this.languageSelected + "/bird-zr.mp3");
                    break;
            case 1: _this.src.setAttribute("src", "questionSounds/NS-INT-4-G6/" + _this.languageSelected + "/bird-pl-1.mp3");
                        break; 
            case 2: _this.src.setAttribute("src", "questionSounds/NS-INT-4-G6/" + _this.languageSelected + "/bird-pl-2.mp3");
                        break;
            case 3: _this.src.setAttribute("src", "questionSounds/NS-INT-4-G6/" + _this.languageSelected + "/bird-pl-3.mp3");
                        break;
            case 4: _this.src.setAttribute("src", "questionSounds/NS-INT-4-G6/" + _this.languageSelected + "/bird-pl-4.mp3");
                        break;
            case 5: _this.src.setAttribute("src", "questionSounds/NS-INT-4-G6/" + _this.languageSelected + "/bird-pl-5.mp3");
                        break;
        }
    ...
    getVoice3:function()
    {
        ...
        switch(_this.Q4_fishQn)
        {
            ...
            case -1: _this.src.setAttribute("src", "questionSounds/NS-INT-4-G6/" + _this.languageSelected + "/fish-mns-1.mp3");
                        break; 
            case -2: _this.src.setAttribute("src", "questionSounds/NS-INT-4-G6/" + _this.languageSelected + "/fish-mns-2.mp3");
                        break;
            case -3: _this.src.setAttribute("src", "questionSounds/NS-INT-4-G6/" + _this.languageSelected + "/fish-mns-3.mp3");
                        break;
            case -4: _this.src.setAttribute("src", "questionSounds/NS-INT-4-G6/" + _this.languageSelected + "/fish-mns-4.mp3");
                        break;
            case -5: _this.src.setAttribute("src", "questionSounds/NS-INT-4-G6/" + _this.languageSelected + "/fish-mns-5.mp3");
                        break;
         }
