...
Game.Score.prototype={
    ...
    ScoreUpdate: function()
    {
        ...
        console.log("game initialize 1 " );
        telInitializer.tele_saveAssessment(currentgame + "1","yes", 1);
        
        telInitializer.gameIdInit(currentgame + "2");
        console.log("game initialize 2 " );
        telInitializer.tele_saveAssessment(currentgame + "2","yes", 1);
        
        telInitializer.gameIdInit(currentgame + "3");
        console.log("game initialize 3 " );
        telInitializer.tele_saveAssessment(currentgame + "3","yes", 1);
        
        telInitializer.gameIdInit(currentgame + "4");
        console.log("game initialize 4 " );
        telInitializer.tele_saveAssessment(currentgame + "4","yes", 1);
        
        telInitializer.gameIdInit(currentgame + "5");
        console.log("game initialize 5 " );
        telInitializer.tele_saveAssessment(currentgame + "5","yes", 1);
        
        telInitializer.gameIdInit(currentgame + "6");
        console.log("game initialize 6 " );
        telInitializer.tele_saveAssessment(currentgame + "6","yes", 1);
