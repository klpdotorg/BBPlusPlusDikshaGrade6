...
//*************************************************************************************************
        ...
        _this.demoAudio1src.setAttribute("src", "questionSounds/NS-OE-1A-G6/" + 
        ...
        _this.demoAudio2src.setAttribute("src", "questionSounds/NS-OE-1A-G6/" + 
        ...
        _this.q1Soundsrc.setAttribute("src", "questionSounds/NS-OE-1A-G6/" + 
        ...
        _this.q2Soundsrc.setAttribute("src", "questionSounds/NS-OE-1A-G6/" + 
        ...
        _this.q3Soundsrc.setAttribute("src", "questionSounds/NS-OE-1B-G6/" + 
        ...
        _this.q4Soundsrc.setAttribute("src", "questionSounds/NS-OE-1A-G6/" + 
                                         _this.languageSelected + "/OE-drag.mp3");
    ...
    showDemoVideo: function()
    {
        ...
        _this.demoVideo_1.changeSource('demoVideos/NS-OE-1-G6_1.mp4');
        ...
        {
            _this.demoVideo_1.stop();
            _this.demoVideo_2.play(false);
            _this.demoVideo_2.changeSource('demoVideos/NS-OE-1-G6_2.mp4');  //* phaser needs this.to run in mobile
