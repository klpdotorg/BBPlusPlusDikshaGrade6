...
//                    _this.delayq2(); 
    ...
    askQn1:function()
    {
        ...
        _this.Question1src.setAttribute("src", "questionSounds/NSF-13-G6/" + _this.languageSelected + "/NSF-13-G6-a.mp3");
    ...
    askQn11:function()
    {
        ...
        _this.Question11src.setAttribute("src", "questionSounds/NSF-13-G6/" + _this.languageSelected + "/NSF-13-G6-b.mp3");
    ...
    askQn2: function () 
    {
        ...
        _this.Question2src.setAttribute("src","questionSounds/NSF-13-G6/" + _this.languageSelected + "/NSF-13-G6-c.mp3");
    ...
    askQn3: function ()
     {
        ...
        _this.Question3src.setAttribute("src", "questionSounds/NSF-13-G6/" + _this.languageSelected + "/NSF-13-G6-d.mp3");
...
//                            console.log("This is else when remainder is zero. celebrating....");
    ...
    DemoVideo: function()
    {
        ...
        _this.demoAudio1src.setAttribute("src", "questionSounds/NSF-13-G6/" + 
        ...
        _this.q1Soundsrc.setAttribute("src", "questionSounds/NSF-13-G6/" + 
      ...
      //  //* Remove the fraction pieces and drag to the second tray
        ...
        _this.q2Soundsrc.setAttribute("src", "questionSounds/NSF-13-G6/" + 
      ...
      //  //*Drag the remaining fraction pieces to the whole.
        ...
        _this.q3Soundsrc.setAttribute("src", "questionSounds/NSF-13-G6/" + 
        ...
        _this.q4Soundsrc.setAttribute("src", "questionSounds/NSF-13-G6/" + 
   ...
   // * function & actual videos/audios to understand the flow of audio and video.
    ...
    showDemoVideo: function()
    {
        ...
        _this.demoVideo_1.changeSource("demoVideos/NSF-13-G6_1.mp4");
