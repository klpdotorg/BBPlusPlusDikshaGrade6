...
Game.NS_INT_3_G6level1.prototype ={
    ...
    init:function(game)
    {
       ...
       //telInitializer.gameIdInit("sequence2_1_1a",gradeSelected);
        ...
        _this.src_1.setAttribute("src", "questionSounds/NS-INT-3-G6/" + _this.languageSelected + "/NS-INT-2A-G6-b.mp3");
        ...
        _this.src_2.setAttribute("src", "questionSounds/NS-INT-3-G6/" + _this.languageSelected + "/NS-INT-2A-G6-a.mp3");
