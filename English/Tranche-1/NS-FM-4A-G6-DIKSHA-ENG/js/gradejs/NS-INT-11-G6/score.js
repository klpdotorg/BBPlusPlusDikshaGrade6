Game.NS_INT_11_G6Score=function(game){

};

Game.NS_INT_11_G6Score.prototype={
	create:function(game){
		
        console.log("inside NS_INT_11_G6Score js" );
		_this = this;
		...
		_this.nextBtn.events.onInputDown.add(function()
		{
            ...
            _this.clickSound.play();
			//_this.cache.destroy();
			_this.state.start('NS_INT_12_G6level1',true,false); 
		},_this);
