...
//*************************************************************************************************
        ...
        _this.demoAudio1src.setAttribute("src", "questionSounds/NS-INT-6-G6/" + 
        ...
        _this.demoAudio2src.setAttribute("src", "questionSounds/NS-INT-6-G6/" + 
        ...
        _this.demoAudio3src.setAttribute("src", "questionSounds/NS-INT-6-G6/" + 
        ...
        _this.demoAudio4src.setAttribute("src", "questionSounds/NS-INT-6-G6/" + 
        ...
        _this.q1Soundsrc.setAttribute("src", "questionSounds/NS-INT-6-G6/" + 
        ...
        _this.q2Soundsrc.setAttribute("src", "questionSounds/NS-INT-6-G6/" + 
        ...
        _this.q3Soundsrc.setAttribute("src", "questionSounds/NS-INT-6-G6/" + 
        ...
        _this.q4Soundsrc.setAttribute("src", "questionSounds/NS-INT-6-G6/" + 
        ...
        _this.q5Soundsrc.setAttribute("src", "questionSounds/NS-INT-6-G6/" + 
                                         _this.languageSelected + "/NS-INT-4-G6-a.mp3");
        ...
        _this.q6Soundsrc.setAttribute("src", "questionSounds/NS-INT-6-G6/" + 
                                         _this.languageSelected + "/NS-INT-4-G6-a.mp3");
    ...
    showDemoVideo: function()
    {
        ...
        _this.demoVideo_1.changeSource('demoVideos/NS-INT-4-G6_1.mp4');
        ...
        _this.demoVideo_1.onComplete.add(function()  //* after video3 is done, start the game
        {
            ...
            _this.demoVideo_2.changeSource('demoVideos/NS-INT-4-G6_2.mp4');  //* phaser needs this.to run in mobile
        ...
        _this.demoVideo_2.onComplete.add(function()  
        {
             ...
             _this.demoVideo_3.changeSource('demoVideos/NS-INT-4-G6_3.mp4');  //* phaser needs this.to run in mobile
             _this.video_playing = 2;
