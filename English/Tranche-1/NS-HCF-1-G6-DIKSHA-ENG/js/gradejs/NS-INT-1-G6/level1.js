...
//    },
    ...
    getVoice2: function () {
        ...
        if (_this.Q1_PosQn == 1) {
            _this.src.setAttribute("src", "questionSounds/NS-INT-1-G6/" + _this.languageSelected + "/pl-1.mp3");

        } else if (_this.Q1_PosQn == 2) {
            _this.src.setAttribute("src", "questionSounds/NS-INT-1-G6/" + _this.languageSelected + "/pl-2.mp3");

        } else if (_this.Q1_PosQn == 3) {
            _this.src.setAttribute("src", "questionSounds/NS-INT-1-G6/" + _this.languageSelected + "/pl-3.mp3");

        } else if (_this.Q1_PosQn == 4) {
            _this.src.setAttribute("src", "questionSounds/NS-INT-1-G6/" + _this.languageSelected + "/pl-4.mp3");

        } else if (_this.Q1_PosQn == 5) {
            _this.src.setAttribute("src", "questionSounds/NS-INT-1-G6/" + _this.languageSelected + "/pl-5.mp3");

        } else if (_this.Q1_PosQn == 0) {
            _this.src.setAttribute("src", "questionSounds/NS-INT-1-G6/" + _this.languageSelected + "/zr.mp3");

        } else if (_this.Q1_PosQn == -1) {
            _this.src.setAttribute("src", "questionSounds/NS-INT-1-G6/" + _this.languageSelected + "/mns-1.mp3");

        } else if (_this.Q1_PosQn == -2) {
            _this.src.setAttribute("src", "questionSounds/NS-INT-1-G6/" + _this.languageSelected + "/mns-2.mp3");

        } else if (_this.Q1_PosQn == -3) {
            _this.src.setAttribute("src", "questionSounds/NS-INT-1-G6/" + _this.languageSelected + "/mns-3.mp3");

        } else if (_this.Q1_PosQn == -4) {
            _this.src.setAttribute("src", "questionSounds/NS-INT-1-G6/" + _this.languageSelected + "/mns-4.mp3");

        } else if (_this.Q1_PosQn == -5) {
            _this.src.setAttribute("src", "questionSounds/NS-INT-1-G6/" + _this.languageSelected + "/mns-5.mp3");
