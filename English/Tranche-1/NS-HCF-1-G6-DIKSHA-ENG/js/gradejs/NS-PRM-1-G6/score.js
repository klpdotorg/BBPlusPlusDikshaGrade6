Game.NS_PRM_1_G6Score=function(game){

};

Game.NS_PRM_1_G6Score.prototype={
	create:function(game){
		
        console.log("inside NS_PRM_1_G6Score js" );
		_this = this;
		...
		_this.nextBtn.events.onInputDown.add(function()
		{
            ...
            //_this.clickSound.play();
			//_this.cache.destroy();
			_this.state.start('NS_PRM_1_G6level1',true,false); 
		},_this);
