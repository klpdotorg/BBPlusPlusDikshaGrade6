...
Game.preloader_fm_4a.prototype={
	preload:function(){
        ...
        this.load.video('fm_4_1','demoVideos/NS-FM-4-G6_1.mp4');  //* intro to game
        this.load.video('fm_4_2','demoVideos/NS-FM-4-G6_2.mp4');  //* fm4a game playing
        this.load.video('fm_4_3','demoVideos/NS-FM-4-G6_3.mp4');  //* fm4b game playing

		this.load.image('skipArrow','assets/commonAssets/skipArrow.png');
		this.load.atlas('backbtn','assets/commonAssets/backbtn.png' ,null,NS_FM_4A_G6_JSON.backbtnJson);
        this.load.atlas('CommonSpeakerBtn','assets/commonAssets/speaker.png' ,null,NS_FM_4A_G6_JSON.speakerJson);
        this.load.atlas('starAnim','assets/commonAssets/starAnim.png',null,NS_FM_4A_G6_JSON.starAnimJson);
        this.load.image('numpadbg','assets/commonAssets/numbg.png');
        this.load.image('TextBox','assets/gradeAssets/NS-FM-4A-G6/text box2.png');
        this.load.atlas('Numberpad','assets/gradeAssets/NS-FM-4A-G6/number pad.png',null,NS_FM_4A_G6_JSON.numberpadJson);
        this.load.atlas('thumbsdown','assets/gradeAssets/NS-FM-4A-G6/thums down.png',null,NS_FM_4A_G6_JSON.thumbsdownJson);
        this.load.atlas('Numberbox','assets/gradeAssets/NS-FM-4A-G6/Nuber box.png',null,NS_FM_4A_G6_JSON.NumberJson);
        this.load.atlas('thumbsup','assets/gradeAssets/NS-FM-4A-G6/thums Up.png',null,NS_FM_4A_G6_JSON.thumbsupJson);
        this.load.atlas('rightbtn','assets/gradeAssets/NS-FM-4A-G6/Right Btn.png',null,NS_FM_4A_G6_JSON.RightbtnJson);
        this.load.atlas('replay','assets/commonAssets/reply.png' ,null,NS_FM_4A_G6_JSON.replyJson);
        this.load.atlas('btn','assets/commonAssets/btn.png',null,NS_FM_4A_G6_JSON.btnJson);
        ...
        this.load.image('bg', 'assets/gradeAssets/NS-FM-4A-G6/BG.png');

        this.load.atlas('FourColorBox','assets/gradeAssets/NS-FM-4A-G6/4 color box.png',null,NS_FM_4A_G6_JSON.fourColorBox);

        this.load.image('EmptyBox', 'assets/gradeAssets/NS-FM-4A-G6/image_2.png');
        this.load.image('EmptyBox_Glow', 'assets/gradeAssets/NS-FM-4A-G6/image_4.png');
        this.load.image('RedBox', 'assets/gradeAssets/NS-FM-4A-G6/Red box.png');
