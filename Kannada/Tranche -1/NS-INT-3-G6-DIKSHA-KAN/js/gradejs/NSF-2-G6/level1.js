...
Game.NSF_2_G6level1.prototype =
{
    ...
    askQn1:function(){
        ...
        _this.Question1src.setAttribute("src", "questionSounds/NSF-2-G6/" + 
                                       _this.languageSelected + "/how_Many_Cubes_are_there.mp3");
    ...
    askQn2:function(){
        ...
        _this.Question2src.setAttribute("src", "questionSounds/NSF-2-G6/" + 
                                       _this.languageSelected + "/Represent_the_shaded_cubes_as_fractions.mp3");
    ...
    numClicked:function(target)
    {
       ...
       if(_this.selectedAns2==='')
        ...
        if(_this.denominator==true){
            ...
            if(Number(''+_this.selectedAns1+_this.selectedAns2)<10){
                _this.enterTxt = _this.add.text(16,9,"" +var_selectedAns1+var_selectedAns2, { fontSize: '30px' });//43 23
            }
            else if(Number(''+_this.selectedAns1+_this.selectedAns2)>=10){
                _this.enterTxt = _this.add.text(9,9,"" +var_selectedAns1+var_selectedAns2, { fontSize: '30px' });//36 23
            }
