...
Game.NSF_8_G6level1.prototype =
{
    ...
    init:function(game)
    {
        ...
        _this.frameChangeSoundsrc.setAttribute("src", "sounds/Frame_change_sound.mp3");
    ...
    voicenote1:function(){
        ...
        _this.playsound1src.setAttribute("src", "questionSounds/NSF-8-G6/" + 
    ...
    askQn1:function(){
        ...
        _this.Question1src.setAttribute("src", "questionSounds/NSF-8-G6/" + 
    ...
    askQn2:function(){
        ...
        _this.Question2src.setAttribute("src", "questionSounds/NSF-8-G6/" + 
...
//            console.log(target.name);
    ...
    DemoVideo: function()
    {
        ...
        _this.demoAudio1src.setAttribute("src", "questionSounds/NSF-8-G6/" + 
        ...
        _this.q1Soundsrc.setAttribute("src", "questionSounds/NSF-8-G6/" + 
                                         _this.languageSelected + "/NSF-8-G6-a.mp3");
        ...
        _this.q2Soundsrc.setAttribute("src", "questionSounds/NSF-8-G6/" + 
                                         _this.languageSelected + "/NSF-8-G6-b.mp3");
        ...
        _this.q3Soundsrc.setAttribute("src", "questionSounds/NSF-8-G6/" + 
                                         _this.languageSelected + "/NSF-8-G6-c.mp3");
    ...
    showDemoVideo: function()
    {
        ...
        _this.demoVideo_1.changeSource("demoVideos/NSF-8-G6_1.mp4");
