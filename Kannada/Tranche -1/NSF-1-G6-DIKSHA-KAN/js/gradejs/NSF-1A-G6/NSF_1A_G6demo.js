...
//*************************************************************************************************
        ...
        _this.demoAudio1src.setAttribute("src", "questionSounds/NSF-1A-G6/" + 
        ...
        _this.demoAudio2src.setAttribute("src", "questionSounds/NSF-1B-G6/" + 
    ...
    {       
        ...
        this.load.video('nsf1_a','demoVideos/NSF-1A-G6.mp4');
        this.load.video('nsf1_b','demoVideos/NSF-1B-G6.mp4');
...
//        });
    ...
    showDemoVideo: function()
    {
        ...
        _this.demoVideo_1.changeSource("demoVideos/NSF-1A-G6.mp4");
        ...
        _this.demoVideo_1.onComplete.add(function()   //* on completion of video3, go to the game.
        {
           ...
           _this.time.events.add(1300, function()
            {               
                ...
                _this.demoVideo_2.changeSource("demoVideos/NSF-1B-G6.mp4");
