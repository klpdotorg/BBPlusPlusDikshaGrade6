...
//        console.log( "HHHHHHHHHHHHHpath is: " + loc + ": " + dir);
        ...
        _this.arrangeinpairs.setAttribute("src", "questionSounds/NS-OE-1A-G6/" + _this.languageSelected 
                                          + "/OE-drag.mp3");
...
//    },
    ...
    askOddQuestion:function(){
        ...
        _this.oddquestionSoundsrc.setAttribute("src", "questionSounds/NS-OE-1B-G6/" + _this.languageSelected 
                                               + "/NS-OE-1B-G6-b.mp3");
    ...
    askEvenQuestion:function(){
        ...
        _this.evenquestionSoundsrc.setAttribute("src", "questionSounds/NS-OE-1B-G6/" + _this.languageSelected 
                                                + "/NS-OE-1B-G6-a.mp3");
