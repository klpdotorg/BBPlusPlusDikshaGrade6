...
Game.NS_INT_10_G6level1.prototype =
{
    ...
    init:function(game)
    {
        ...
        _this.nullyficationSoundsrc.setAttribute("src", "sounds/Game_Asset_Disappear.mp3");
...
//        _this.QnAsTxtGroup2 = _this.add.group();
    ...
    {    
        ...
        _this.Questionsrc.setAttribute("src", "questionSounds/NS-INT-10-G6/" + _this.languageSelected + "/Int-Op-q.mp3");
...
//                _this.time.events.add(5000,function(){ window.parent.location.reload();});
                console.log("transitioning to show score");
                _this.time.events.add(5000,function()
                { 
