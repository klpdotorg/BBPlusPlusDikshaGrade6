Game.numbers_int_3_g6Score=function(game){

};

Game.numbers_int_3_g6Score.prototype={
	create:function(game){
		...
		_this.nextBtn.events.onInputDown.add(function()
		{
            ...
            _this.clickSound.play();
			//_this.cache.destroy();
			_this.state.start('preloader_int_4',true,false); 
		},_this);
        ...
        _this.replay.events.onInputDown.add(function(){ 
            ...
            //_this.clickSound = _this.add.audio('ClickSound');
            //_this.clickSound.play();
            _this.state.start('numbers_int_3_g6l1',true,false);
         },_this);
