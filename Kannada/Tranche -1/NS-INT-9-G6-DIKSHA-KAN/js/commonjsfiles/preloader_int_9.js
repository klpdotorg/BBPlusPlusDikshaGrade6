...
//        this.load.image('topicOutline','assets/commonAssets/topicOutline.png');
        ...
        this.load.atlas('minus_anm','assets/gradeAssets/NS-INT-7-G6/minus animation.png' ,null,NS_INT_07_G6_JSON.minus_animationJson);
        this.load.atlas('plus_anm', 'assets/gradeAssets/NS-INT-7-G6/plus animation.png' ,null, NS_INT_07_G6_JSON.plus_animationJson);
        
        this.load.atlas('flipbtn','assets/gradeAssets/NS-INT-7-G6/plus and minus Box.png',null,NS_INT_07_G6_JSON.flipbtnJson);
...
//        this.load.image('base', 'assets/gradeAssets/NS-INT-7-G6/Main panel.png');
        ...
        this.load.atlas('plus','assets/gradeAssets/NS-INT-7-G6/plus symbol.png', null, NS_INT_07_G6_JSON.plusglowJson);
        this.load.atlas('minus','assets/gradeAssets/NS-INT-7-G6/minus symbol.png', null, NS_INT_07_G6_JSON.minusglowJson);
        this.load.atlas('QnABox','assets/gradeAssets/NS-INT-7-G6/Q n A Box.png',null,NS_INT_07_G6_JSON.questionAndAnswerBoxJson);        		
	},
