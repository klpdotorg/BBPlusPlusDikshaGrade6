Game.NS_INT_7_G6Score=function(game){

};

Game.NS_INT_7_G6Score.prototype={
	create:function(game){
		
        console.log("inside NS_INT_7_G6Score js" );
		_this = this;
		...
		_this.nextBtn.events.onInputDown.add(function()
		{
            ...
            //_this.clickSound.play();
			//_this.cache.destroy();
			_this.state.start('NS_INT_8_G6level1',true,false); 
		},_this);
        ...
        _this.replay.events.onInputDown.add(function(){ 
            ...
            //_this.clickSound = _this.add.audio('ClickSound');
            //_this.clickSound.play();
            _this.state.start('NS_INT_7_G6level1',true,false);
         },_this);
