...
//        game.plugins.add(_this.shake);
    ...
    askQn1: function () {
        ...
        _this.Question1src.setAttribute("src", "questionSounds/NSF-9A-G6/" + 
    ...
    DemoVideo: function()
    {
        ...
        _this.demoAudio1src.setAttribute("src", "questionSounds/NSF-9A-G6/" + 
        ...
        _this.q1Soundsrc.setAttribute("src", "questionSounds/NSF-9A-G6/" + 
                                         _this.languageSelected + "/NSF-9-G6-a.mp3");
        ...
        _this.q2Soundsrc.setAttribute("src", "questionSounds/NSF-9A-G6/" + 
    ...
    showDemoVideo: function()
    {
        ...
        _this.demoVideo_1.changeSource("demoVideos/NSF-9-G6_1.mp4");
