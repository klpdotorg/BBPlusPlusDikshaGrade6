...
Game.NSF_15_G6level1.prototype =
{
    ...
    init:function()
    {
        ...
        _this.giveShadeSoundsrc.setAttribute("src", "sounds/Frame_change_sound.mp3");
    ...
    voiceNote1:function()
    {
            ...
            _this.Question1src.setAttribute("src", "questionSounds/NSF-15-G6/" + _this.languageSelected + "/NSF-15-G6-a.mp3");
    ...
    voiceNote2:function()
    {
            ...
            _this.Question2src.setAttribute("src", "questionSounds/NSF-15-G6/" + _this.languageSelected + "/NSF-15-G6-c.mp3");
    ...
    voiceNote3:function()
    {
            ...
            _this.Question3src.setAttribute("src", "questionSounds/NSF-15-G6/" + _this.languageSelected + "/NSF-15-G6-b.mp3");
    ...
    voiceNote4:function()
    {
            ...
            _this.Question4src.setAttribute("src", "questionSounds/NSF-15-G6/" + _this.languageSelected + "/NSF-15-G6-e.mp3");
    ...
    voiceNote5:function()
    {
            ...
            _this.Question5src.setAttribute("src", "questionSounds/NSF-15-G6/" + _this.languageSelected + "/NSF-15-G6-d.mp3"); 
    ...
    nextquestion:function()
    {
        _this.time.events.add(2000,function()
        {
            ...
            else
            {
                _this.timer1.stop();
                _this.timer1=null;
                _this.time.events.add(3000,function(){ _this.state.start('score')});
    ...
    DemoVideo:function()
    {
        ...
        _this.demoAudio1src.setAttribute("src", "questionSounds/NSF-15-G6/" + 
        ...
        _this.demoAudio2src.setAttribute("src", "questionSounds/NSF-15-G6/" + 
        ...
        _this.demoAudio3src.setAttribute("src", "questionSounds/NSF-15-G6/" + 
        ...
        _this.q1Soundsrc.setAttribute("src", "questionSounds/NSF-15-G6/" + 
        ...
        _this.q2Soundsrc.setAttribute("src", "questionSounds/NSF-15-G6/" + 
        ...
        _this.q3Soundsrc.setAttribute("src", "questionSounds/NSF-15-G6/" + 
        ...
        _this.q4Soundsrc.setAttribute("src", "questionSounds/NSF-15-G6/" + 
        ...
        _this.q5Soundsrc.setAttribute("src", "questionSounds/NSF-15-G6/" + 
    ...
    showDemoVideo:function()
    {
        ...
        _this.demoVideo_1.changeSource("demoVideos/NSF-15-G6_1.mp4");
