...
// Resets frog positio n if selected tile is wrong
    ...
    askdemo1: function () {
        ...
        _this.demoVo1src.setAttribute("src", "questionSounds/NS-INT-5H-G6/"+_this.languageSelected +"/NS-INT-5-G6 demo 1_2.mp3");
    ...
    askdemo2: function () {
        ...
        _this.demoVo2src.setAttribute("src", "questionSounds/NS-INT-5H-G6/"+_this.languageSelected +"/NS-INT-5-G6 demo 2_2.mp3");
    ...
    askdemo3: function () {
        ...
        _this.demoVo3src.setAttribute("src", "questionSounds/NS-INT-5H-G6/"+_this.languageSelected +"/NS-INT-5-G6 demo 3_2.mp3");
