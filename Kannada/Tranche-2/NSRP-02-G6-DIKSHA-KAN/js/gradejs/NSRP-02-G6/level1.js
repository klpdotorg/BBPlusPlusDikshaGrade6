...
Game.NSRP_02_G6level1.prototype =
{
    ...
    createAudio: function (src) {
        ...
        audiosrc.setAttribute("src", "questionSounds/NSRP-02-G6/" + _this.languageSelected + "/" + src + ".mp3");
    ...
    DemoVideo: function () {
        ...
        _this.demoAudio1src.setAttribute("src", "questionSounds/NSRP-02-G6/" + _this.languageSelected + "/DV-NSRP-02-G6.mp3");
        _this.demoAudio1.appendChild(_this.demoAudio1src);

        //*  4 is to 1 as 8 is to 2 
        _this.demoAudio2 = document.createElement('audio');
        _this.demoAudio2src = document.createElement('source');
        _this.demoAudio2src.setAttribute("src", "questionSounds/NSRP-02-G6/" + _this.languageSelected + "/DV1-NSRP-02-G6.mp3");
        _this.demoAudio2.appendChild(_this.demoAudio2src);

        //* Place the objects as per required ratio
        _this.q1Sound = document.createElement('audio');
        _this.q1Soundsrc = document.createElement('source');
        _this.q1Soundsrc.setAttribute("src", "questionSounds/NSRP-02-G6/" +
        ...
        _this.q2Soundsrc.setAttribute("src", "questionSounds/NSRP-02-G6/" +
    ...
    showDemoVideo: function () {
        ...
        _this.demoVideo_1.changeSource("demoVideos/NSRP-02-G6.mp4");
