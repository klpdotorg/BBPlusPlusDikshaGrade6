...
Game.GMAN_01_G6level1.prototype={
  ...
  if(!window.grade5SG2){
            ...
            this.load.image('commonBg2', 'assets/gradeAssets/GMAN-01-G6/commonBg2.png');

            this.load.atlas('grade11_speaker','assets/commonAssets/grade11_speaker.png','assets/commonAssets/grade11_speaker.json');
            this.load.atlas('newCommonBackBtnForAll','assets/commonAssets/backbtn.png','assets/commonAssets/backbtn.json');
            this.load.atlas('starAnim1','assets/commonAssets/starAnim1.png','assets/commonAssets/starAnim1.json');

            //GAME ASSETS  
            this.load.image('SG21_2_5protractor','assets/gradeAssets/GMAN-01-G6/protractor.png');
            this.load.image('SG21_2_5graphic','assets/gradeAssets/GMAN-01-G6/graphic.png');
            this.load.atlas('SG21_2_5rightmark','assets/gradeAssets/GMAN-01-G6/rightmark.png', 'assets/gradeAssets/GMAN-01-G6/JSON/rightmark.json');
            this.load.atlas('tickBtn','assets/gradeAssets/GMAN-01-G6/rightBtn.png', 'assets/gradeAssets/GMAN-01-G6/JSON/RightButton.json');
            this.load.atlas('SG21_2_5line','assets/gradeAssets/GMAN-01-G6/line.png', 'assets/gradeAssets/GMAN-01-G6/JSON/line.json');
            this.load.atlas('SG21_2_5angle1','assets/gradeAssets/GMAN-01-G6/angle1.png', 'assets/gradeAssets/GMAN-01-G6/JSON/angle1.json');
            this.load.atlas('SG21_2_5angle2', 'assets/gradeAssets/GMAN-01-G6/angle2.png', 'assets/gradeAssets/GMAN-01-G6/JSON/angle2.json');
            this.load.atlas('circle_arc', 'assets/gradeAssets/GMAN-01-G6/geometry.png', 'assets/gradeAssets/GMAN-01-G6/JSON/geometry.json');
            this.load.atlas('SG21_2_5numbers', 'assets/gradeAssets/GMAN-01-G6/numbers.png', 'assets/gradeAssets/GMAN-01-G6/JSON/numbers.json');
            this.load.image('SG21_2_5degree', 'assets/gradeAssets/GMAN-01-G6/degree.png');
            ...
            this.load.image('Newprotractor','assets/gradeAssets/GMAN-01-G6/protractorNew.png');
       }
    },
   ...
   // _this.languageSelected + "/AL-MEM01-G6-e.mp3"
        ...
        switch(_this.qArrays[_this.no11]) //_this.qArrays[_this.no11]
        {
            case 1: if(_this.languageSelected == "ENG")
                    {
                        console.log("here")
                        _this.src.setAttribute("src", "questionSounds/GMAN-01-G6/"+ _this.languageSelected + "/GMAN-01-G6A.mp3");
                    }
            ...
            case 2: if(_this.languageSelected =="ENG")
                    { console.log("here")
                         _this.src.setAttribute("src",  "questionSounds/GMAN-01-G6/"+ _this.languageSelected + "/GMAN-01-G6B.mp3");
                    }
                    else if(_this.languageSelected =="HIN")
                    {
                         _this.src.setAttribute("src",  "questionSounds/GMAN-01-G6/"+ _this.languageSelected + "/GMAN-01-G6B.mp3");
                    ...
                    {
                        _this.src.setAttribute("src",  "questionSounds/GMAN-01-G6/"+ _this.languageSelected + "/sg21.2.5b.mp3");
                        //_this.amplify = this.amplifyMedia(_this.playQuestionSound, 3);
                    }
					else if(_this.languageSelected =="MAR")
                    {
            ...
            case 3:if(_this.languageSelected =="ENG")
                    { console.log("here")
                         _this.src.setAttribute("src",  "questionSounds/GMAN-01-G6/"+ _this.languageSelected + "/GMAN-01-G6C.mp3");
                    }
                    else if(_this.languageSelected =="HIN")
                    {
                         _this.src.setAttribute("src",  "questionSounds/GMAN-01-G6/"+ _this.languageSelected + "/GMAN-01-G6C.mp3");
                    ...
                    {
                        _this.src.setAttribute("src",  "questionSounds/GMAN-01-G6/"+ _this.languageSelected + "/sg21.2.5c.mp3");
                        //_this.amplify = this.amplifyMedia(_this.playQuestionSound, 3);
                    }
					else if(_this.languageSelected =="MAR")
                    {
            ...
            case 4:if(_this.languageSelected =="ENG")
                    { console.log("here")
                        _this.src.setAttribute("src",  "questionSounds/GMAN-01-G6/"+ _this.languageSelected + "/GMAN-01-G6D.mp3");
                    }
                    else if(_this.languageSelected =="HIN")
                    {
                        _this.src.setAttribute("src",  "questionSounds/GMAN-01-G6/"+ _this.languageSelected + "/GMAN-01-G6D.mp3");
                    ...
                    {
                        _this.src.setAttribute("src",  "questionSounds/GMAN-01-G6/"+ _this.languageSelected + "/sg21.2.5d.mp3");
                        //_this.amplify = this.amplifyMedia(_this.playQuestionSound, 3);
                    }
					else if(_this.languageSelected =="MAR")
                    {
                    ...
                    {
                         _this.src.setAttribute("src",  "questionSounds/GMAN-01-G6/TEL/sg21.2.5d.mp3");
                    }
					else if(_this.languageSelected =="TAM")
                    {
                         _this.src.setAttribute("src",  "questionSounds/GMAN-01-G6/TAM/sg21.2.5d.mp3");
                    }
					else if(_this.languageSelected =="URD")
                    {
                         _this.src.setAttribute("src",  "questionSounds/GMAN-01-G6/URD/sg21.2.5d.mp3");
                    }
                    else
                    {
                        _this.src.setAttribute("src",  "questionSounds/GMAN-01-G6/ODI/sg21.2.5d.mp3");
                    }
                    break;
            case 5: if(_this.languageSelected =="ENG")
                    { console.log("here")
                         _this.src.setAttribute("src",  "questionSounds/GMAN-01-G6/"+ _this.languageSelected + "/GMAN-01-G6E.mp3");
                    }
                    else if(_this.languageSelected =="HIN")
                    {
                         _this.src.setAttribute("src",  "questionSounds/GMAN-01-G6/"+ _this.languageSelected + "/GMAN-01-G6E.mp3");
                    ...
                    {
                        _this.src.setAttribute("src", "questionSounds/GMAN-01-G6/GUJ/sg21.2.5e.mp3");
                        //_this.amplify = this.amplifyMedia(_this.playQuestionSound, 3);
                    }
					else if(_this.languageSelected =="MAR")
                    {
                         _this.src.setAttribute("src",  "questionSounds/GMAN-01-G6/MAR/sg21.2.5e.mp3");
                    }
					else if(_this.languageSelected =="TEL")
                    {
                         _this.src.setAttribute("src",  "questionSounds/GMAN-01-G6/TEL/sg21.2.5e.mp3");
                    }
					else if(_this.languageSelected =="TAM")
                    {
                         _this.src.setAttribute("src",  "questionSounds/GMAN-01-G6/TAM/sg21.2.5e.mp3");
                    }
					else if(_this.languageSelected =="URD")
                    {
                         _this.src.setAttribute("src",  "questionSounds/GMAN-01-G6/URD/sg21.2.5e.mp3");
                    }
                    else
                    {
                        _this.src.setAttribute("src",  "questionSounds/GMAN-01-G6/ODI/sg21.2.5e.mp3");
                    }
                    break;
            case 6: if(_this.languageSelected =="ENG")
                    { console.log("here")
                         _this.src.setAttribute("src",  "questionSounds/GMAN-01-G6/"+ _this.languageSelected + "/GMAN-01-G6F.mp3");
                    }
                    else if(_this.languageSelected =="HIN")
                    {
                         _this.src.setAttribute("src",  "questionSounds/GMAN-01-G6/"+ _this.languageSelected + "/GMAN-01-G6F.mp3");
                    ...
                    {
                        _this.src.setAttribute("src",  "questionSounds/GMAN-01-G6/GUJ/sg21.2.5f.mp3");
                        //_this.amplify = this.amplifyMedia(_this.playQuestionSound, 3);
                    }
					else if(_this.languageSelected =="MAR")
                    {
                         _this.src.setAttribute("src",  "questionSounds/GMAN-01-G6/MAR/sg21.2.5f.mp3");
                    }
					else if(_this.languageSelected =="TEL")
                    {
                         _this.src.setAttribute("src",  "questionSounds/GMAN-01-G6/TEL/sg21.2.5f.mp3");
                    }
					else if(_this.languageSelected =="TAM")
                    {
                         _this.src.setAttribute("src",  "questionSounds/GMAN-01-G6/TAM/sg21.2.5f.mp3");
                    }
					else if(_this.languageSelected =="URD")
                    {
                         _this.src.setAttribute("src", "questionSounds/GMAN-01-G6/URD/sg21.2.5f.mp3");
                    }
                    else
                    {
                        _this.src.setAttribute("src",  "questionSounds/GMAN-01-G6/ODI/sg21.2.5f.mp3");
                    }
                    break;
            case 7:if(_this.languageSelected == "ENG")
                    { console.log("here")
                         _this.src.setAttribute("src",  "questionSounds/GMAN-01-G6/"+ _this.languageSelected + "/GMAN-01-G6G.mp3");
                    }
                    else if(_this.languageSelected =="HIN")
                    {
                         _this.src.setAttribute("src",  "questionSounds/GMAN-01-G6/"+ _this.languageSelected + "/GMAN-01-G6G.mp3");
                    ...
                    {
                        _this.src.setAttribute("src",  "questionSounds/GMAN-01-G6/GUJ/sg21.2.5g.mp3");
                        //_this.amplify = this.amplifyMedia(_this.playQuestionSound, 3);
                    }
					else if(_this.languageSelected =="MAR")
                    {
                         _this.src.setAttribute("src",  "questionSounds/GMAN-01-G6/MAR/sg21.2.5g.mp3");
                    }
					else if(_this.languageSelected =="TEL")
                    {
                         _this.src.setAttribute("src",  "questionSounds/GMAN-01-G6/TEL/sg21.2.5g.mp3");
                    }
					else if(_this.languageSelected =="TAM")
                    {
                         _this.src.setAttribute("src",  "questionSounds/GMAN-01-G6/TAM/sg21.2.5g.mp3");
                    }
					else if(_this.languageSelected =="URD")
                    {
                         _this.src.setAttribute("src",  "questionSounds/GMAN-01-G6/URD/sg21.2.5g.mp3");
                    }
                    else
                    {
                        _this.src.setAttribute("src",  "questionSounds/GMAN-01-G6/ODI/sg21.2.5g.mp3");
                    }
                    break;
            case 8:if(_this.languageSelected =="ENG")
                    { console.log("here")
                         _this.src.setAttribute("src",  "questionSounds/GMAN-01-G6/"+ _this.languageSelected + "/GMAN-01-G6H.mp3");
                    }
                    else if(_this.languageSelected =="HIN")
                    {
                         _this.src.setAttribute("src",  "questionSounds/GMAN-01-G6/"+ _this.languageSelected + "/GMAN-01-G6H.mp3");
                    ...
                    {
                         _this.src.setAttribute("src",  "questionSounds/GMAN-01-G6/MAR/sg21.2.5h.mp3");
                    }
					else if(_this.languageSelected =="TEL")
                    {
                         _this.src.setAttribute("src",  "questionSounds/GMAN-01-G6/TEL/sg21.2.5h.mp3");
                    }
					else if(_this.languageSelected =="TAM")
                    {
                         _this.src.setAttribute("src",  "questionSounds/GMAN-01-G6/TAM/sg21.2.5h.mp3");
                    }
					else if(_this.languageSelected =="URD")
                    {
                         _this.src.setAttribute("src",  "questionSounds/GMAN-01-G6/URD/sg21.2.5h.mp3");
                    }
                   else if(_this.languageSelected =="GUJ")
                    {
                        _this.src.setAttribute("src",  "questionSounds/GMAN-01-G6/GUJ/sg21.2.5h.mp3");
                        //_this.amplify = this.amplifyMedia(_this.playQuestionSound, 3);
                    }
                    else
                    {
                        _this.src.setAttribute("src",  "questionSounds/GMAN-01-G6/ODI/sg21.2.5h.mp3");
                    }
                    break;
            ...
            case 9: if(_this.languageSelected =="ENG")
                    { 
                        console.log("here")
                        _this.src.setAttribute("src",  "questionSounds/GMAN-01-G6/"+ _this.languageSelected + "/GMAN-01-G6I.mp3");
                    }
                    else if(_this.languageSelected =="HIN")
                    {
                         _this.src.setAttribute("src",  "questionSounds/GMAN-01-G6/"+ _this.languageSelected + "/GMAN-01-G6I.mp3");
                    ...
                    {
                        _this.src.setAttribute("src",  "questionSounds/GMAN-01-G6/GUJ/sg21.2.5i.mp3");
                        //_this.amplify = this.amplifyMedia(_this.playQuestionSound, 3);
                    }
					else if(_this.languageSelected =="MAR")
                    {
                         _this.src.setAttribute("src",  "questionSounds/GMAN-01-G6/MAR/sg21.2.5i.mp3");
                    }
					else if(_this.languageSelected =="TEL")
                    {
                         _this.src.setAttribute("src",  "questionSounds/GMAN-01-G6/TEL/sg21.2.5i.mp3");
                    }
					else if(_this.languageSelected =="TAM")
                    {
                         _this.src.setAttribute("src",  "questionSounds/GMAN-01-G6/TAM/sg21.2.5i.mp3");
                    }
					else if(_this.languageSelected =="URD")
                    {
                         _this.src.setAttribute("src",  "questionSounds/GMAN-01-G6/URD/sg21.2.5i.mp3");
                    }
                    else
                    {
                        _this.src.setAttribute("src",  "questionSounds/GMAN-01-G6/ODI/sg21.2.5i.mp3");
                    }
                    break;
            ...
            case 10:if(_this.languageSelected == "ENG")
                    { 
                        console.log("here")
                        _this.src.setAttribute("src",  "questionSounds/GMAN-01-G6/"+ _this.languageSelected + "/GMAN-01-G6J.mp3");
                    }
                    else if(_this.languageSelected =="HIN")
                    {
                        _this.src.setAttribute("src",  "questionSounds/GMAN-01-G6/"+ _this.languageSelected + "/GMAN-01-G6J.mp3");
                    ...
                    {
                        _this.src.setAttribute("src",  "questionSounds/GMAN-01-G6/GUJ/sg21.2.5j.mp3");
                        //_this.amplify = this.amplifyMedia(_this.playQuestionSound, 3);
                    }
					else if(_this.languageSelected =="MAR")
                    {
                        _this.src.setAttribute("src",  "questionSounds/GMAN-01-G6/MAR/sg21.2.5j.mp3");
                    }
					else if(_this.languageSelected == "TEL")
                    {
                         _this.src.setAttribute("src",  "questionSounds/GMAN-01-G6/TEL/sg21.2.5j.mp3");
                    }
					else if(_this.languageSelected =="TAM")
                    {
                         _this.src.setAttribute("src",  "questionSounds/GMAN-01-G6/TAM/sg21.2.5j.mp3");
                    }
					else if(_this.languageSelected =="URD")
                    {
                         _this.src.setAttribute("src",  "questionSounds/GMAN-01-G6/URD/sg21.2.5j.mp3");
                    }
                    else
                    {
                        _this.src.setAttribute("src", "questionSounds/GMAN-01-G6/ODI/sg21.2.5j.mp3");
                    }
                    break;
            case 11:if(_this.languageSelected == "ENG")
                    { console.log("here")
                         _this.src.setAttribute("src",  "questionSounds/GMAN-01-G6/"+ _this.languageSelected + "/GMAN-01-G6K.mp3");
                    }
            ...
            case 12:if(_this.languageSelected == "ENG")
                    { console.log("here")
                         _this.src.setAttribute("src",  "questionSounds/GMAN-01-G6/"+ _this.languageSelected + "/GMAN-01-G6L.mp3");
                    }
                    else if(_this.languageSelected =="HIN")
                    {
                         _this.src.setAttribute("src",  "questionSounds/GMAN-01-G6/"+ _this.languageSelected + "/GMAN-01-G6L.mp3");
            ...
            case 13:if(_this.languageSelected == "ENG")
                    { console.log("here")
                        _this.src.setAttribute("src",  "questionSounds/GMAN-01-G6/"+ _this.languageSelected + "/GMAN-01-G6M.mp3");
                    }
                    else if(_this.languageSelected =="HIN")
                    {
                         _this.src.setAttribute("src",  "questionSounds/GMAN-01-G6/"+ _this.languageSelected + "/GMAN-01-G6M.mp3");
