...
Game.NSD_4D_G6level1.prototype =
{
    ...
    gameCreate: function (game) {
        ...
        _this.backbtn.events.onInputDown.add(function () {
            // _this.state.start('NSD_4D_G6Score');
    ...
    createAudio: function (src) {
        ...
        audiosrc.setAttribute("src", "questionSounds/NSD-4D-G6/" + _this.languageSelected + "/" + src + ".mp3");
    ...
    DemoVideo: function () {
        ...
        _this.demoAudio1src.setAttribute("src", "questionSounds/NSD-4D-G6/" +
            _this.languageSelected + "/DV-NSD-4D-G6.mp3");
        _this.demoAudio1.appendChild(_this.demoAudio1src);

        _this.q1Sound = document.createElement('audio');
        _this.q1Soundsrc = document.createElement('source');
        _this.q1Soundsrc.setAttribute("src", "questionSounds/NSD-4D-G6/" +
            _this.languageSelected + "/NSD-4D-G6A.mp3");
        _this.q1Sound.appendChild(_this.q1Soundsrc);

        _this.q2Sound = document.createElement('audio');
        _this.q2Soundsrc = document.createElement('source');
        _this.q2Soundsrc.setAttribute("src", "questionSounds/NSD-4D-G6/" +
    ...
    showDemoVideo: function () {
        ...
        _this.demoVideo_1.changeSource("demoVideos/NSD-4D-G6.mp4");
