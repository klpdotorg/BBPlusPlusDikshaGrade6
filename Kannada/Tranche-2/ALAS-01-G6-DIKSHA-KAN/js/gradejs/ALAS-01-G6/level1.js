...
Game.ALAS_01_G6level1.prototype =
{
    ...
    init: function (game) 
    {
        ...
        _this.clungSoundsrc.setAttribute("src", "sounds/clung.mp3");
        ...
        _this.bellSoundsrc.setAttribute("src", "sounds/bell.mp3");
        ...
        _this.bottleSoundsrc.setAttribute("src", "sounds/bottle_clank.mp3");
        ...
        _this.SmallRewardSoundsrc.setAttribute("src", "sounds/Small Reward.mp3");
        ...
        _this.Car_lockSoundsrc.setAttribute("src", "sounds/Car_lock.mp3");
        ...
        _this.GamePositiveSoundsrc.setAttribute("src", "sounds/Game Positive.mp3");
    ...
    askQn1: function ()
     {
        ...
        _this.Question1src.setAttribute("src", "questionSounds/ALAS-01-G6/" + _this.languageSelected + "/ALAS-01-G6B.mp3");
    ...
    //     _this.Question11src.setAttribute("src", "questionSounds/ALAS-01-G6" + _this.languageSelected + "/");
    ...
    askQn2: function () 
    {
        ...
        _this.Question2src.setAttribute("src", "questionSounds/ALAS-01-G6/" + _this.languageSelected + "/ALAS-01-G6C.mp3");
    ...
    askQn3: function () 
    {
        ...
        _this.Question3src.setAttribute("src", "questionSounds/ALAS-01-G6/" + _this.languageSelected + "/ALAS-01-G6D.mp3");
...
//            _this.RedCarTrayGroup.getChildAt(_this.RedCarTrayGroup.length -1).events.onInputDown.add(_this.tweeningUP,_this);
    ...
    DemoVideo: function ()
     {
        ...
        _this.demoAudio1src.setAttribute("src", "questionSounds/ALAS-01-G6/" +
        ...
        _this.q1Soundsrc.setAttribute("src", "questionSounds/ALAS-01-G6/" +
        ...
        _this.q2Soundsrc.setAttribute("src", "questionSounds/ALAS-01-G6/" +
        ...
        _this.q3Soundsrc.setAttribute("src", "questionSounds/ALAS-01-G6/" +
        ...
        _this.q4Soundsrc.setAttribute("src", "questionSounds/ALAS-01-G6/" +
    ...
    showDemoVideo: function () 
    {
        ...
        _this.demoVideo_1.changeSource("demoVideos/ALAS-01-G6_1.mp4");
        ...
        _this.demoVideo_1.onComplete.add(function ()   //* on completion of demovideo close the video
        {
            ...
            _this.demoVideo_2.changeSource("demoVideos/ALAS-01-G6_2.mp4");  //* phaser needs this.to run in mobile
