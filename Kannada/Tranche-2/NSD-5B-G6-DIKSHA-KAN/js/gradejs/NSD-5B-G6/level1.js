...
Game.NSD_5B_G6level1.prototype = {
    init: function (game) {
        ...
        _this.CashOutsrc.setAttribute("src", "sounds/CashOutNew.mp3");
        ...
        _this.frameSoundsrc.setAttribute("src", "sounds/Frame_change_sound.mp3");
    ...
    createAudio: function (src) {
        ...
        audiosrc.setAttribute("src", "questionSounds/NSD-5B-G6/" + _this.languageSelected + "/" + src + ".mp3");
    ...
    gameCreate: function (game) {
        ...
        _this.backbtn.events.onInputDown.add(function () {
            ...
            //_this.state.start('NSD_5B_G6Score');
    ...
    DemoVideo:function()
    {
        ...
        _this.demoAudio1src.setAttribute("src", "questionSounds/NSD-5B-G6/" + _this.languageSelected + "/DV-NSD-5B-G6.mp3");
        _this.demoAudio1.appendChild(_this.demoAudio1src);

        //* Drag the strips and square pieces onto the grid to represent the given decimal number.
        _this.q1Sound = document.createElement('audio');
        _this.q1Soundsrc = document.createElement('source');
        _this.q1Soundsrc.setAttribute("src", "questionSounds/NSD-5B-G6/" + 
        ...
        _this.q2Soundsrc.setAttribute("src", "questionSounds/NSD-5B-G6/" + 
        ...
        _this.q3Soundsrc.setAttribute("src", "questionSounds/NSD-5B-G6/" + 
    ...
    showDemoVideo:function()
    {
        ...
        _this.demoVideo_1.changeSource("demoVideos/NSD-5B-G6.mp4");
