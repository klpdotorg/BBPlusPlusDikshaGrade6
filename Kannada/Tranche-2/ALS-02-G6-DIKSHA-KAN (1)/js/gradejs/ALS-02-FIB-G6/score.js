Game.ALS_02_FIB_G6Score=function(game){

};

Game.ALS_02_FIB_G6Score.prototype={
	create:function(game){
		
        console.log("inside ALS_02_FIB_G6Score js" );
		_this = this;
		...
		_this.nextBtn.events.onInputDown.add(function()
		{
            ...
            //_this.clickSound.play();
			//_this.cache.destroy();
			_this.state.start('ALS_02_FIB_G6level1',true,false); 
		},_this);
