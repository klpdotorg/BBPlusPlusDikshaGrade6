...
Game.NSD_4E_G6level1.prototype =
{
    init: function (param, score) {
        ...
        _this.waterSoundsrc.setAttribute("src", "sounds/waterFillingSound.mp3");
        ...
        _this.waterSound2src.setAttribute("src", "sounds/WaterFillNewSound.mpeg");
    ...
    gameCreate: function (game) {
        ...
        _this.backbtn.events.onInputDown.add(function () {
            //_this.state.start('NSD_4E_G6Score');
    ...
    createAudio: function (src) {
        ...
        audiosrc.setAttribute("src", "questionSounds/NSD-4E-G6/" + _this.languageSelected + "/" + src + ".mp3");
    ...
    rightbtnClicked2: function () {
        ...
        if (_this.part1 == true) {
            if (_this.AnswerBox.name === _this.ansBox1) {
                _this.counterCelebrationSound.play()
                _this.part1 = false;
                _this.part2 = true;
            ...
            if (_this.AnswerBox.name === _this.ansBox2 || _this.AnswerBox.name === _this.ansBox22 ) {
                _this.counterCelebrationSound.play()
                _this.part2 = false;
    ...
    DemoVideo:function()
    {
        ...
        _this.demoAudio1src.setAttribute("src", "questionSounds/NSD-4E-G6/" + 
                                            _this.languageSelected + "/DV-NSD-4E-G6.mp3");
        _this.demoAudio1.appendChild(_this.demoAudio1src);

        _this.q1Sound = document.createElement('audio');
        _this.q1Soundsrc = document.createElement('source');
        _this.q1Soundsrc.setAttribute("src", "questionSounds/NSD-4E-G6/" + 
                                        _this.languageSelected + "/NSD-4E-G6A.mp3");
        _this.q1Sound.appendChild(_this.q1Soundsrc);

        _this.q2Sound = document.createElement('audio');
        _this.q2Soundsrc = document.createElement('source');
        _this.q2Soundsrc.setAttribute("src", "questionSounds/NSD-4E-G6/" + 
    ...
    showDemoVideo:function()
    {
        ...
        _this.demoVideo_1.changeSource("demoVideos/NSD-4E-G6.mp4");
