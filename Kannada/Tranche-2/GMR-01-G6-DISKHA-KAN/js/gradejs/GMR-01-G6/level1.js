...
Game.GMR_01_G6level1.prototype =
{
    init: function (param, score) {
        ...
        _this.bubbleSoundsrc.setAttribute("src", "sounds/Bubbles.mp3");
    ...
    create: function (game) {
        ...
        _this.backbtn.events.onInputDown.add(function () {
            //_this.state.start('GMR_01_G6Score');
    ...
    createAudio: function (src) {
        ...
        audiosrc.setAttribute("src", "questionSounds/GMR-01-G6/" + _this.languageSelected + "/" + src + ".mp3");
